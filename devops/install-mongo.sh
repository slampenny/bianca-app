...
# Login to Amazon ECR
aws ecr get-login-password --region us-east-2 | docker login --username AWS --password-stdin mongo:4.2.1-bionic
...
docker run -d --name mongodb -p 27017:27017 mongo:4.2.1-bionic
