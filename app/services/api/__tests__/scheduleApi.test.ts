...
describe('scheduleApi', () => {
  ...
  beforeEach(async () => {
    ...
    const resultSchedule = await scheduleApi.endpoints.createSchedule
      .initiate({ patientId, data: newSchedule() })(store.dispatch, store.getState, {});
  ...
  it('should create a schedule', async () => {
    ...
    const result = await scheduleApi.endpoints.createSchedule
      .initiate({ patientId, data: newSchedulePayload })(store.dispatch, store.getState, {});
    ...
    if ('data' in result && result.data) {
      ...
      const resultPatient = await patientApi.endpoints.getPatient
        .initiate({ id: patientId })(store.dispatch, store.getState, {});
  ...
  it('should get a schedule', async () => {
    const result = await scheduleApi.endpoints.getSchedule
      .initiate({ scheduleId })(store.dispatch, store.getState, {});
  ...
  it('should update a schedule', async () => {
    ...
    const result = await scheduleApi.endpoints.updateSchedule
      .initiate({ scheduleId, data: updatedSchedule })(store.dispatch, store.getState, {});
  ...
  it('should delete a schedule', async () => {
    const result = await scheduleApi.endpoints.deleteSchedule
      .initiate({ scheduleId })(store.dispatch, store.getState, {});
