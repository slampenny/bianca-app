...
export const RegisterScreen = (props: StackScreenProps<LoginStackParamList, 'Register'>) => {
  ...
  const clearFieldError = (field: string) => {
    switch(field) {
      ...
      case 'password': setPasswordError(''); break;
      case 'confirmPassword': setConfirmPasswordError(''); break;
      case 'phone': setPhoneError(''); break;
      case 'organizationName': setOrganizationNameError(''); break;
    }
    setGeneralError('');
  }
  ...
  return (
    ...
    >
      <div style={{ padding: '20px' }}>
        {generalError ? <Text style={generalError.includes('successful') ? styles.successText : styles.errorText}>{generalError}</Text> : null}
