...
const CONVERSATION_STATES = {
  ...
  WAITING_FOR_GREETING: 'waiting_for_greeting', // Session ready; silence fallback armed until resident speaks or timer fires
...
const STATE_TRANSITIONS = {
  ...
  [CONVERSATION_STATES.WAITING_FOR_GREETING]: [
    CONVERSATION_STATES.GREETING_ACTIVE,
    CONVERSATION_STATES.USER_SPEAKING, // Resident speaks first (before silence fallback)
    // Late ASR after noise re-arm: resident-first cancel with speech already ended
  ...
  // WAITING_FOR_GREETING: connect noise can trip speech_started then fail confirm → re-arm silence fallback
  [CONVERSATION_STATES.USER_SPEAKING]: [
    CONVERSATION_STATES.AI_RESPONDING,
    CONVERSATION_STATES.WAITING_FOR_GREETING,
    CONVERSATION_STATES.CALL_ENDING,
    CONVERSATION_STATES.ERROR,
  ],
  [CONVERSATION_STATES.AI_RESPONDING]: [
    CONVERSATION_STATES.USER_SPEAKING,
    CONVERSATION_STATES.CONVERSATION_ACTIVE,
    // Short/noise speech during the open greeting window can re-arm silence-fallback listen
    CONVERSATION_STATES.WAITING_FOR_GREETING,
    CONVERSATION_STATES.CALL_ENDING,
    CONVERSATION_STATES.ERROR,
  ],
