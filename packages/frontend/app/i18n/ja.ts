...
const ja: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "詳細",
    openDetailsHint: "このアラートの根拠、次のステップ、クライアントの文脈を開く",
  },
  alertDetail: {
    title: "アラートの詳細",
    notFound: "このアラートは利用できません。一覧に戻ってください。",
    consentSectionA11y: "このクライアントの録音同意の状態",
    consentHeading: "録音への同意",
    consentOnFile: "このクライアントの同意は記録されています。",
    consentMissing:
      "録音同意の記録がありません。臨床上・法的な前提を置く前に確認してください。",
    consentRecordedAt: "記録日時：",
    evidenceHeading: "根拠",
    detectorLabel: "ソース：",
    confidenceLabel: "モデルの信頼度：",
    detectors: {
      unknown: "不明",
      embedding_pipeline: "意味モデル＋ルール",
      phrase_match: "フレーズ一致",
    },
    viewConversation: "会話を表示",
    nextStepsHeading: "推奨される次のステップ",
    contextHeading: "クライアントの文脈",
    openClient: "クライアントのプロフィールを開く",
    openHealthReport: "健康分析レポートを開く",
    openRiskReport: "詐欺・安全レポートを開く",
    relatedAlertsHeading: "このクライアントの他のアラート",
    openConsentCenter: "このクライアントの同意センターを開く",
  },
  alertActions: {
    callEmergencyServices: "状況に応じて救急サービスに連絡してください",
    reviewConversation: "最近の会話を確認する",
    notifyCareTeam: "ケアチームと調整する",
    documentInRecord: "記録にフォローを残す",
    openRiskReport: "詐欺・安全の分析を確認する",
  },
  consentCenter: {
    title: "同意センター",
    subtitle:
      "クライアントとスタッフの同意記録を確認します。監査用に整合性フィンガープリント付きの CSV または PDF をエクスポートできます。",
    adminOnly: "組織の管理者のみが同意センターを開けます。",
    filterAll: "すべてのクライアント",
    filterLabel: "クライアントで絞り込み",
    auditScopeLabel: "監査の範囲",
    scopeSingleOrg: "1 つの組織",
    scopeAllOrgs: "すべての組織",
    orgPickerLabel: "組織",
    pickOrg: "監査を読み込む組織を選択してください。",
    scopeLabel: "範囲:",
    exportCsv: "CSV をダウンロード",
    exportPdf: "PDF をダウンロード",
    exportPdfFileName: "同意監査 (PDF)",
    refreshing: "読み込み中…",
    empty: "この条件に一致する同意記録はありません。",
    errorLoad: "同意記録を読み込めませんでした。",
    rowClient: "クライアント",
    rowStaff: "スタッフ",
    rowOrganization: "組織:",
    rowType: "種類",
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "クライアントオンボーディング",
  ...
  profileScreen: {
    ...
    requestMyData: "マイデータの請求",
    consentCenter: "同意センター（組織）",
  ...
  headers: {
    ...
    privacyPolicy: "プライバシーポリシー",
    privacyPractices: "HIPAAプライバシー慣行",
    privacyRequest: "マイデータの請求",
    consentCenter: "同意センター",
