...
const ja: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "詳細",
    openDetailsHint: "このアラートの根拠、次のステップ、入居者の文脈を開く",
  },
  alertDetail: {
    title: "アラートの詳細",
    notFound: "このアラートは利用できません。一覧に戻ってください。",
    consentSectionA11y: "この入居者の録音同意の状態",
    consentHeading: "録音への同意",
    consentOnFile: "この入居者の同意は記録されています。",
    consentMissing:
    ...
    contextHeading: "入居者の文脈",
    openResident: "入居者プロフィールを開く",
    openHealthReport: "健康分析レポートを開く",
    openRiskReport: "詐欺・安全レポートを開く",
    relatedAlertsHeading: "この入居者の他のアラート",
    openConsentCenter: "この入居者の同意センターを開く",
  },
  alertActions: {
  ...
  consentCenter: {
    title: "同意センター",
    subtitle:
      "入居者とスタッフの同意記録を確認します。監査用に整合性フィンガープリント付きの CSV または PDF をエクスポートできます。",
    adminOnly: "組織の管理者のみが同意センターを開けます。",
    filterAll: "すべての入居者",
    filterLabel: "入居者で絞り込み",
