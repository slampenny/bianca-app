...
const ja: LocaleTranslations = {
  ...
  fraudAbuseAnalysis: {
    ...
    success: "成功",
    noClientSelected: "患者が選択されていません",
    selectClientToView: "詐欺と虐待の分析を表示するには患者を選択してください",
    triggering: "トリガー中...",
  ...
  caregiverScreen: {
    ...
    patientsAssignedSuccess: "クライアントの割り当てが完了しました！",
  ...
  sentimentAnalysis: {
    ...
    allTime: "全期間",
    noClientSelected: "患者が選択されていません",
    selectClientToView: "感情分析を表示するには、ホーム画面から患者を選択してください。",
    patientSentimentAnalysis: "クライアント感情分析",
  ...
  medicalAnalysis: {
    ...
    success: "成功",
    noClientSelected: "患者が選択されていません",
    selectClientToView: "医学的分析を表示するには患者を選択してください",
    triggering: "トリガー中...",
    triggerAnalysis: "分析をトリガー",
    loadingResults: "分析結果を読み込み中...",
    noResultsAvailable: "分析結果が利用できません",
