...
const pt: LocaleTranslations = {
  ...
  conversationsScreen: {
    ...
    noClientSelected: "Nenhum paciente selecionado",
  ...
  fraudAbuseAnalysis: {
    ...
    success: "Sucesso",
    noClientSelected: "Nenhum paciente selecionado",
    selectClientToView: "Por favor selecione um paciente para ver a análise de fraude e abuso",
    triggering: "Ativando...",
  ...
  reportsScreen: {
    ...
    chooseClient: "Escolher um paciente...",
  ...
  caregiverScreen: {
    ...
    patientsAssignedSuccess: "Clientes atribuídos com sucesso!",
  ...
  sentimentAnalysis: {
    ...
    noClientSelected: "Nenhum paciente selecionado",
    selectClientToView: "Por favor, selecione um paciente da tela inicial para ver sua análise de sentimentos.",
    patientSentimentAnalysis: "Análise de sentimentos do cliente",
    ...
    clientMoodAssessment: "Avaliação do humor do paciente",
  ...
  medicalAnalysis: {
    ...
    success: "Sucesso",
    noClientSelected: "Nenhum paciente selecionado",
    selectClientToView: "Por favor, selecione um paciente para ver a análise médica",
