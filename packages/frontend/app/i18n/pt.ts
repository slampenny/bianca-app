...
const pt: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetailsHint: "Abrir evidências, próximos passos e contexto do cliente para este alerta",
  },
  alertDetail: {
    title: "Detalhes do alerta",
    notFound: "Este alerta não está disponível. Volte à lista.",
    consentSectionA11y: "Estado do consentimento de gravação para este cliente",
    consentHeading: "Consentimento de gravação",
    consentOnFile: "Há consentimento registado para este cliente.",
    consentMissing:
      "Não há consentimento de gravação registado. Verifique antes de assumir implicações clínicas ou legais.",
    consentRecordedAt: "Registado:",
    evidenceHeading: "Evidências",
    detectorLabel: "Origem:",
    confidenceLabel: "Confiança do modelo:",
    detectors: {
      unknown: "Desconhecido",
      embedding_pipeline: "Modelo semântico + regras",
      phrase_match: "Correspondência de frase",
    },
    viewConversation: "Ver conversas",
    nextStepsHeading: "Próximos passos sugeridos",
    contextHeading: "Contexto do cliente",
    openClient: "Abrir perfil do cliente",
    openHealthReport: "Abrir relatório de análise de saúde",
    openRiskReport: "Abrir relatório de fraude e segurança",
    relatedAlertsHeading: "Outros alertas para este cliente",
    openConsentCenter: "Abrir centro de consentimentos para este cliente",
  },
  alertActions: {
    callEmergencyServices: "Contacte os serviços de emergência se a situação o exigir",
    reviewConversation: "Rever a conversa recente",
    notifyCareTeam: "Coordenar com a equipa de cuidados",
    documentInRecord: "Documentar o acompanhamento nos seus registos",
    openRiskReport: "Rever a análise de fraude e segurança",
  },
  consentCenter: {
    title: "Centro de consentimentos",
    subtitle:
      "Consulte os registos de consentimento de clientes e equipa. Exporte CSV ou PDF com impressão digital de integridade para auditorias.",
    adminOnly: "Apenas administradores da organização podem abrir o centro de consentimentos.",
    filterAll: "Todos os clientes",
    filterLabel: "Filtrar por cliente",
    auditScopeLabel: "Âmbito da auditoria",
    scopeSingleOrg: "Uma organização",
    scopeAllOrgs: "Todas as organizações",
    orgPickerLabel: "Organização",
    pickOrg: "Selecione uma organização para carregar a auditoria.",
    scopeLabel: "Âmbito:",
    exportCsv: "Transferir CSV",
    exportPdf: "Transferir PDF",
    exportPdfFileName: "Auditoria de consentimentos (PDF)",
    refreshing: "A carregar…",
    empty: "Nenhum registo de consentimento corresponde a este filtro.",
    errorLoad: "Não foi possível carregar os registos de consentimento.",
    rowClient: "Cliente",
    rowStaff: "Equipa",
    rowOrganization: "Organização:",
    rowType: "Tipo",
    rowGranted: "Concedido",
    rowMethod: "Método",
    rowRecorded: "Registado",
    rowVia: "Via",
    yes: "Sim",
    no: "Não",
    exportFileName: "Auditoria de consentimentos",
  },
  legalLinks: {
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "Integração do cliente",
  ...
  profileScreen: {
    ...
    requestMyData: "Pedir os meus dados",
    consentCenter: "Centro de consentimentos (organização)",
  ...
  headers: {
    ...
    privacyPolicy: "Política de privacidade",
    privacyPractices: "Práticas de Privacidade HIPAA",
    privacyRequest: "Pedir os meus dados",
    consentCenter: "Centro de consentimentos",
  ...
  homeScreen: {
    ...
    glanceHintAlertsBody:
      "Quantos alertas da sua lista estão ligados a este cliente (por exemplo conversa ou agenda). Abra a aba Alertas para ler ou gerenciar. Alertas sem cliente associado não entram nesta contagem.",
