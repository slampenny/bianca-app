...
const pt: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetailsHint: "Abrir evidências, próximos passos e contexto do residente para este alerta",
  },
  alertDetail: {
    title: "Detalhes do alerta",
    notFound: "Este alerta não está disponível. Volte à lista.",
    consentSectionA11y: "Estado do consentimento de gravação para este residente",
    consentHeading: "Consentimento de gravação",
    consentOnFile: "Há consentimento registado para este residente.",
    consentMissing:
    ...
    contextHeading: "Contexto do residente",
    openResident: "Abrir perfil do residente",
    openHealthReport: "Abrir relatório de análise de saúde",
    openRiskReport: "Abrir relatório de fraude e segurança",
    relatedAlertsHeading: "Outros alertas para este residente",
    openConsentCenter: "Abrir centro de consentimentos para este residente",
  },
  alertActions: {
  ...
  consentCenter: {
    ...
    subtitle:
      "Consulte os registos de consentimento de residentes e equipa. Exporte CSV ou PDF com impressão digital de integridade para auditorias.",
    adminOnly: "Apenas administradores da organização podem abrir o centro de consentimentos.",
    filterAll: "Todos os residentes",
