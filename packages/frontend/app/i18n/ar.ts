...
const ar: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetailsHint: "افتح الأدلة والخطوات التالية وسياق العميل لهذا التنبيه",
  },
  alertDetail: {
    title: "تفاصيل التنبيه",
    notFound: "هذا التنبيه غير متاح. ارجع إلى القائمة.",
    consentSectionA11y: "حالة موافقة التسجيل لهذا العميل",
    consentHeading: "موافقة التسجيل",
    consentOnFile: "موافقة مسجلة لهذا العميل.",
    consentMissing:
      "لا توجد موافقة تسجيل مسجلة. تحقق قبل الافتراضات السريرية أو القانونية.",
    consentRecordedAt: "سُجّلت:",
    evidenceHeading: "الأدلة",
    detectorLabel: "المصدر:",
    confidenceLabel: "ثقة النموذج:",
    detectors: {
      unknown: "غير معروف",
      embedding_pipeline: "نموذج دلالي + قواعد",
      phrase_match: "تطابق عبارة",
    },
    viewConversation: "عرض المحادثات",
    nextStepsHeading: "الخطوات التالية المقترحة",
    contextHeading: "سياق العميل",
    openClient: "فتح ملف العميل",
    openHealthReport: "فتح تقرير تحليل الصحة",
    openRiskReport: "فتح تقرير الاحتيال والسلامة",
    relatedAlertsHeading: "تنبيهات أخرى لهذا العميل",
    openConsentCenter: "فتح مركز الموافقات لهذا العميل",
  },
  alertActions: {
    callEmergencyServices: "اتصل بخدمات الطوارئ إذا تطلب الأمر",
    reviewConversation: "راجع المحادثة الأخيرة",
    notifyCareTeam: "نسّق مع فريق الرعاية",
    documentInRecord: "وثّق المتابعة في سجلاتك",
    openRiskReport: "راجع تحليل الاحتيال والسلامة",
  },
  consentCenter: {
    title: "مركز الموافقات",
    subtitle:
      "اطّلع على سجلات موافقة العملاء والموظفين. صدّر CSV أو PDF ببصمة سلامة للمراجعة.",
    adminOnly: "يمكن لمسؤولي المؤسسة فقط فتح مركز الموافقات.",
    filterAll: "جميع العملاء",
    filterLabel: "تصفية حسب العميل",
    auditScopeLabel: "نطاق المراجعة",
    scopeSingleOrg: "مؤسسة واحدة",
    scopeAllOrgs: "جميع المؤسسات",
    orgPickerLabel: "المؤسسة",
    pickOrg: "اختر مؤسسة لتحميل المراجعة.",
    scopeLabel: "النطاق:",
    exportCsv: "تنزيل CSV",
    exportPdf: "تنزيل PDF",
    exportPdfFileName: "مراجعة الموافقات (PDF)",
    refreshing: "جاري التحميل…",
    empty: "لا توجد سجلات موافقة تطابق هذا التصفية.",
    errorLoad: "تعذّر تحميل سجلات الموافقة.",
    rowClient: "عميل",
    rowStaff: "موظف",
    rowOrganization: "المؤسسة:",
    rowType: "النوع",
    rowGranted: "مُمنوح",
    rowMethod: "الطريقة",
    rowRecorded: "سُجّل",
    ...
    yes: "نعم",
    no: "لا",
    exportFileName: "مراجعة الموافقات",
  },
  welcomeScreen: {
    postscript:
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "تهيئة العميل",
  ...
  homeScreen: {
    ...
    glanceHintAlertsBody:
      "عدد التنبيهات في قائمتك المرتبطة بهذا العميل (مثل المحادثة أو الجدول). افتح تبويب التنبيهات لقراءتها أو إدارتها. التنبيهات غير المرتبطة بعميل لا تُحسب هنا.",
  ...
  profileScreen: {
    ...
    consentCenter: "مركز الموافقات (المؤسسة)",
