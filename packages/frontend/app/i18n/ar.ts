...
const ar: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetailsHint: "افتح الأدلة والخطوات التالية وسياق المقيم لهذا التنبيه",
  },
  alertDetail: {
    title: "تفاصيل التنبيه",
    notFound: "هذا التنبيه غير متاح. ارجع إلى القائمة.",
    consentSectionA11y: "حالة موافقة التسجيل لهذا المقيم",
    consentHeading: "موافقة التسجيل",
    consentOnFile: "موافقة مسجلة لهذا المقيم.",
    consentMissing:
    ...
    contextHeading: "سياق المقيم",
    openResident: "فتح ملف المقيم",
    openHealthReport: "فتح تقرير تحليل الصحة",
    openRiskReport: "فتح تقرير الاحتيال والسلامة",
    relatedAlertsHeading: "تنبيهات أخرى لهذا المقيم",
    openConsentCenter: "فتح مركز الموافقات لهذا المقيم",
  },
  alertActions: {
  ...
  consentCenter: {
    ...
    subtitle:
      "اطّلع على سجلات موافقة المقيمين والموظفين. صدّر CSV أو PDF ببصمة سلامة للمراجعة.",
    adminOnly: "يمكن لمسؤولي المؤسسة فقط فتح مركز الموافقات.",
    filterAll: "جميع المقيمين",
    filterLabel: "تصفية حسب المقيم",
