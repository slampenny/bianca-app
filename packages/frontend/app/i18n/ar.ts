...
const ar: LocaleTranslations = {
  ...
  conversationsScreen: {
    ...
    noClientSelected: "لم يتم اختيار مريض",
  ...
  clientScreen: {
    ...
    updateClient: "تحديث المريض",
    createClient: "إنشاء مريض",
  ...
  paymentScreen: {
    ...
    day: "يوم",
    days: "أيام",
    patientsWithCharges: "العملاء مع الرسوم:",
    patient: "عميل",
    patients: "عملاء",
    chargesByPatient: "الرسوم حسب العميل",
    conversation: "محادثة",
  ...
  caregiverScreen: {
    ...
    emailPlaceholder: "البريد الالكتروني",
    phonePlaceholder: "الهاتف",
    loadingUnassignedPatients: "جاري تحميل العملاء غير المخصصين...",
    assigningPatients: "جاري تعيين العملاء...",
    patientsAssignedSuccess: "تم تعيين العملاء بنجاح!",
  ...
  sentimentAnalysis: {
    ...
    allTime: "كل الوقت",
    noClientSelected: "لم يتم اختيار مريض",
    selectClientToView: "يرجى اختيار مريض من الشاشة الرئيسية لعرض تحليل المشاعر.",
    // Dashboard
    patientSentimentAnalysis: "تحليل مشاعر العميل",
    ...
    clientMoodAssessment: "تقييم مزاج المريض",
    ...
    noPatient: "لا يوجد عميل",
    pleaseSelectPatient: "يرجى اختيار عميل أولاً",
  ...
  medicalAnalysis: {
    ...
    success: "نجح",
    noClientSelected: "لم يتم اختيار مريض",
    selectClientToView: "يرجى اختيار مريض لعرض التحليل الطبي",
    triggering: "تشغيل...",
  ...
  fraudAbuseAnalysis: {
    ...
    success: "نجاح",
    noClientSelected: "لم يتم اختيار مريض",
    selectClientToView: "يرجى اختيار مريض لعرض تحليل الاحتيال والإساءة",
    triggering: "تشغيل...",
    triggerAnalysis: "تشغيل التحليل",
