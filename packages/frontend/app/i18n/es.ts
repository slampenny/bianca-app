...
const es: LocaleTranslations = {
  alertScreen: {
    ...
    openDetailsHint: "Abre evidencia, pasos siguientes y contexto del cliente",
  },
  alertDetail: {
    title: "Detalles de la alerta",
    notFound: "Esta alerta no está disponible. Vuelve a la lista.",
    consentSectionA11y: "Estado del consentimiento de grabación para este cliente",
    consentHeading: "Consentimiento de grabación",
    consentOnFile: "Hay consentimiento registrado para este cliente.",
    consentMissing: "No hay consentimiento de grabación registrado. Verifica antes de asumir aspectos clínicos o legales.",
    consentRecordedAt: "Registrado:",
    evidenceHeading: "Evidencia",
    detectorLabel: "Origen:",
    confidenceLabel: "Confianza del modelo:",
    detectors: {
      unknown: "Desconocido",
      embedding_pipeline: "Modelo semántico + reglas",
      phrase_match: "Coincidencia de frases",
    },
    viewConversation: "Ver conversaciones",
    nextStepsHeading: "Pasos sugeridos",
    contextHeading: "Contexto del cliente",
    openClient: "Abrir perfil del cliente",
    openHealthReport: "Abrir informe de salud",
    openRiskReport: "Abrir informe de fraude y seguridad",
    relatedAlertsHeading: "Otras alertas para este cliente",
    openConsentCenter: "Abrir centro de consentimientos para este cliente",
  },
  consentCenter: {
    title: "Centro de consentimientos",
    subtitle:
      "Revisa los registros de consentimiento de clientes y personal. Exporta CSV o un PDF con huella de integridad para auditorías.",
    adminOnly: "Solo los administradores de la organización pueden abrir el centro de consentimientos.",
    filterAll: "Todos los clientes",
    filterLabel: "Filtrar por cliente",
    auditScopeLabel: "Ámbito de auditoría",
    scopeSingleOrg: "Una organización",
    scopeAllOrgs: "Todas las organizaciones",
    orgPickerLabel: "Organización",
    pickOrg: "Selecciona una organización para cargar la auditoría.",
    scopeLabel: "Ámbito:",
    exportCsv: "Descargar CSV",
    exportPdf: "Descargar PDF",
    exportPdfFileName: "Auditoría de consentimientos (PDF)",
    refreshing: "Cargando…",
    empty: "No hay registros de consentimiento para este filtro.",
    errorLoad: "No se pudieron cargar los registros de consentimiento.",
    rowClient: "Cliente",
    rowStaff: "Personal",
    rowOrganization: "Organización:",
    rowType: "Tipo",
    rowGranted: "Otorgado",
    rowMethod: "Método",
    rowRecorded: "Registrado",
    rowVia: "Vía",
    yes: "Sí",
    no: "No",
    exportFileName: "Auditoría de consentimientos",
  },
  alertActions: {
    callEmergencyServices: "Contacta servicios de emergencia si la situación lo requiere",
    reviewConversation: "Revisar la conversación reciente",
    notifyCareTeam: "Coordinar con tu equipo de cuidado",
    documentInRecord: "Documentar el seguimiento en tus registros",
    openRiskReport: "Revisar análisis de fraude y seguridad",
  },
  errorScreen: {
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "Incorporación del cliente",
  ...
  homeScreen: {
    ...
    glanceHintSentimentBody:
      "Resumen del tono del cliente en llamadas analizadas recientes (unos 30 días). Alza, estable o baja compara llamadas más nuevas con otras un poco más antiguas. No es un diagnóstico; usa el informe de sentimiento completo para más detalle.",
    glanceHintHealthTitle: "Puntuación de salud",
    glanceHintHealthBody:
      "Puntuación general del último análisis médico de conversaciones (0–100, más alto es mejor). Combina señales como patrones cognitivos y de estado de ánimo en las llamadas. No sustituye el criterio clínico ni el informe de salud completo.",
    ...
    glanceHintAlertsBody:
      "Cuántas alertas de tu lista están vinculadas a este cliente (por ejemplo conversación u horario). Abre la pestaña Alertas para leerlas o gestionarlas. Las alertas sin cliente vinculado no se cuentan aquí.",
  ...
  headers: {
    ...
    consentCenter: "Centro de consentimientos",
  ...
  profileScreen: {
    ...
    consentCenter: "Centro de consentimientos (organización)",
