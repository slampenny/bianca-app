...
const es: LocaleTranslations = {
  alertScreen: {
    ...
    openDetailsHint: "Abre evidencia, pasos siguientes y contexto del residente",
  },
  alertDetail: {
    title: "Detalles de la alerta",
    notFound: "Esta alerta no está disponible. Vuelve a la lista.",
    consentSectionA11y: "Estado del consentimiento de grabación para este residente",
    consentHeading: "Consentimiento de grabación",
    consentOnFile: "Hay consentimiento registrado para este residente.",
    ...
    contextHeading: "Contexto del residente",
    openResident: "Abrir perfil del residente",
    openHealthReport: "Abrir informe de salud",
    openRiskReport: "Abrir informe de fraude y seguridad",
    relatedAlertsHeading: "Otras alertas para este residente",
    openConsentCenter: "Abrir centro de consentimientos para este residente",
  },
  consentCenter: {
    title: "Centro de consentimientos",
    subtitle:
      "Revisa los registros de consentimiento de residentes y personal. Exporta CSV o un PDF con huella de integridad para auditorías.",
    adminOnly: "Solo los administradores de la organización pueden abrir el centro de consentimientos.",
    filterAll: "Todos los residentes",
    filterLabel: "Filtrar por residente",
