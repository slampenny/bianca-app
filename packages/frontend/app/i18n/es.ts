...
const es: LocaleTranslations = {
  ...
  conversationsScreen: {
    ...
    noClientSelected: "Ningún paciente seleccionado",
  ...
  paymentScreen: {
    ...
    day: "día",
    days: "días",
    patientsWithCharges: "Clientes con cargos:",
    patient: "cliente",
    patients: "clientes",
  ...
  caregiverScreen: {
    ...
    patientsAssignedSuccess: "¡Clientes asignados exitosamente!",
  ...
  sentimentAnalysis: {
    ...
    noClientSelected: "Ningún paciente seleccionado",
    selectClientToView: "Por favor selecciona un paciente desde la pantalla de inicio para ver su análisis de sentimientos.",
    patientSentimentAnalysis: "Análisis de sentimientos del cliente",
    ...
    moreEmotions: "más",
    clientMood: "Estado de ánimo del paciente:",
    ...
    clientMoodAssessment: "Evaluación del estado de ánimo del paciente",
  ...
  medicalAnalysis: {
    ...
    success: "Éxito",
    noClientSelected: "Ningún paciente seleccionado",
    selectClientToView: "Por favor selecciona un paciente para ver el análisis médico",
  ...
  fraudAbuseAnalysis: {
    ...
    error: "Error",
    success: "Éxito",
    noClientSelected: "No se ha seleccionado ningún paciente",
    selectClientToView: "Por favor seleccione un paciente para ver el análisis de fraude y abuso",
    triggering: "Activando...",
    triggerAnalysis: "Activar Análisis",
    loadingResults: "Cargando resultados del análisis...",
    noResultsAvailable: "No hay resultados de análisis disponibles",
  ...
  reportsScreen: {
    ...
    chooseClient: "Elige un paciente...",
