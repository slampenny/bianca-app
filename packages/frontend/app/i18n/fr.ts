...
const fr: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "Détails",
    openDetailsHint: "Ouvrir les preuves, les prochaines étapes et le contexte du client pour cette alerte",
  },
  alertDetail: {
    title: "Détails de l’alerte",
    notFound: "Cette alerte n’est pas disponible. Retournez à la liste.",
    consentSectionA11y: "État du consentement d’enregistrement pour ce client",
    consentHeading: "Consentement d’enregistrement",
    consentOnFile: "Un consentement est enregistré pour ce client.",
    consentMissing:
      "Aucun consentement d’enregistrement enregistré. Vérifiez avant toute hypothèse clinique ou juridique.",
    consentRecordedAt: "Enregistré le :",
    evidenceHeading: "Preuves",
    detectorLabel: "Source :",
    confidenceLabel: "Confiance du modèle :",
    detectors: {
      unknown: "Inconnu",
      embedding_pipeline: "Modèle sémantique + règles",
      phrase_match: "Correspondance de phrase",
    },
    viewConversation: "Voir les conversations",
    nextStepsHeading: "Prochaines étapes suggérées",
    contextHeading: "Contexte du client",
    openClient: "Ouvrir le profil du client",
    openHealthReport: "Ouvrir le rapport d’analyse de santé",
    openRiskReport: "Ouvrir le rapport fraude et sécurité",
    relatedAlertsHeading: "Autres alertes pour ce client",
    openConsentCenter: "Ouvrir le centre de consentement pour ce client",
  },
  alertActions: {
    callEmergencyServices: "Contacter les services d’urgence si la situation l’exige",
    reviewConversation: "Examiner la conversation récente",
    notifyCareTeam: "Coordonner avec l’équipe de soins",
    documentInRecord: "Documenter le suivi dans vos dossiers",
    openRiskReport: "Consulter l’analyse fraude et sécurité",
  },
  consentCenter: {
    title: "Centre de consentement",
    subtitle:
      "Consultez les enregistrements de consentement des clients et du personnel. Exportez un CSV ou un PDF avec empreinte d’intégrité pour les audits.",
    adminOnly: "Seuls les administrateurs de l’organisation peuvent ouvrir le centre de consentement.",
    filterAll: "Tous les clients",
    filterLabel: "Filtrer par client",
    auditScopeLabel: "Portée de l’audit",
    scopeSingleOrg: "Une organisation",
    scopeAllOrgs: "Toutes les organisations",
    orgPickerLabel: "Organisation",
    pickOrg: "Sélectionnez une organisation pour charger l’audit.",
    scopeLabel: "Portée :",
    exportCsv: "Télécharger le CSV",
    exportPdf: "Télécharger le PDF",
    exportPdfFileName: "Audit de consentement (PDF)",
    refreshing: "Chargement…",
    empty: "Aucun enregistrement de consentement ne correspond à ce filtre.",
    errorLoad: "Impossible de charger les enregistrements de consentement.",
    rowClient: "Client",
    rowStaff: "Personnel",
    ...
    rowGranted: "Accordé",
    rowMethod: "Méthode",
    rowRecorded: "Enregistré",
    rowVia: "Via",
    yes: "Oui",
    no: "Non",
    exportFileName: "Audit de consentement",
  },
  legalLinks: {
  ...
  homeScreen: {
    ...
    glanceHintAlertsBody:
      "Nombre d’alertes de votre liste liées à ce client (par exemple conversation ou planning). Ouvrez l’onglet Alertes pour les consulter ou les gérer. Les alertes sans client lié ne sont pas comptées ici.",
  ...
  headers: {
    ...
    consentCenter: "Centre de consentement",
    termsOfService: "Conditions d'utilisation",
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "Accueil du client",
    ...
    onboardingButtonA11yHint: "Ouvre les réponses et le parcours d’accueil de ce client.",
  },
  ...
  profileScreen: {
    ...
    consentCenter: "Centre de consentement (organisation)",
