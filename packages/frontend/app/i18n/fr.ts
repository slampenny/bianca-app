...
const fr: LocaleTranslations = {
  ...
  paymentScreen: {
    ...
    day: "jour",
    days: "jours",
    patientsWithCharges: "Clients avec des charges :",
    patient: "client",
    patients: "clients",
    chargesByPatient: "Charges par client",
  ...
  caregiverScreen: {
    ...
    phoneLabel: "Téléphone",
    phonePlaceholder: "Téléphone",
    loadingUnassignedPatients: "Chargement des clients non assignés...",
    assigningPatients: "Assignation des clients...",
    patientsAssignedSuccess: "Clients assignés avec succès !",
    loadingCaregivers: "Chargement des aidants...",
    save: "ENREGISTRER",
    invite: "INVITER",
    confirmDelete: "CONFIRMER LA SUPPRESSION",
    deleteCaregiver: "SUPPRIMER L'AIDANT",
    assignUnassignedPatients: "Assigner les clients non assignés",
    assignUnassignedPatientsTitle: "Assigner les clients non assignés",
    selectAll: "Tout sélectionner",
    deselectAll: "Tout désélectionner",
    assignSelected: "Assigner la sélection",
    noUnassignedPatientsFound: "Aucun client non assigné trouvé.",
  },
  caregiversScreen: {
    invited: "Invité",
    edit: "Modifier",
  ...
  sentimentAnalysis: {
    ...
    // Dashboard
    patientSentimentAnalysis: "Analyse de sentiment du client",
    ...
    pleaseSelectPatient: "Veuillez d'abord sélectionner un client",
  ...
  reportsScreen: {
    selectPatient: "Sélectionner un client :",
