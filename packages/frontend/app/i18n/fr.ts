...
const fr: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "Détails",
    openDetailsHint: "Ouvrir les preuves, les prochaines étapes et le contexte du résident pour cette alerte",
  },
  alertDetail: {
    title: "Détails de l’alerte",
    notFound: "Cette alerte n’est pas disponible. Retournez à la liste.",
    consentSectionA11y: "État du consentement d’enregistrement pour ce résident",
    consentHeading: "Consentement d’enregistrement",
    consentOnFile: "Un consentement est enregistré pour ce résident.",
    consentMissing:
    ...
    contextHeading: "Contexte du résident",
    openResident: "Ouvrir le profil du résident",
    openHealthReport: "Ouvrir le rapport d’analyse de santé",
    openRiskReport: "Ouvrir le rapport fraude et sécurité",
    relatedAlertsHeading: "Autres alertes pour ce résident",
    openConsentCenter: "Ouvrir le centre de consentement pour ce résident",
  },
  alertActions: {
  ...
  consentCenter: {
    ...
    subtitle:
      "Consultez les enregistrements de consentement des résidents et du personnel. Exportez un CSV ou un PDF avec empreinte d’intégrité pour les audits.",
    adminOnly: "Seuls les administrateurs de l’organisation peuvent ouvrir le centre de consentement.",
    filterAll: "Tous les résidents",
    filterLabel: "Filtrer par résident",
