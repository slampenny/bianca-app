...
const fr: LocaleTranslations = {
  ...
  conversationsScreen: {
    ...
    noClientSelected: "Aucun patient sélectionné",
  ...
  clientScreen: {
    ...
    updateClient: "METTRE À JOUR LE PATIENT",
    createClient: "CRÉER LE PATIENT",
    ...
    deleteClient: "SUPPRIMER LE PATIENT",
  },
  paymentScreen: {
    paid: "Payé",
    pending: "En attente",
  ...
  sentimentAnalysis: {
    ...
    noClientSelected: "Aucun patient sélectionné",
    selectClientToView: "Veuillez sélectionner un patient depuis l'écran d'accueil pour voir son analyse de sentiment.",
    // Dashboard
    ...
    clientMoodAssessment: "Évaluation de l'humeur du patient",
  ...
  medicalAnalysis: {
    ...
    success: "Succès",
    noClientSelected: "Aucun patient sélectionné",
    selectClientToView: "Veuillez sélectionner un patient pour voir l'analyse médicale",
    ...
    insufficientDataWarning: "Données limitées disponibles : {{current}} appel(s) analysé(s). Pour une analyse plus fiable, {{minimum}} appels ou plus sur une période plus longue sont recommandés pour mieux comprendre les modèles du patient.",
  ...
  fraudAbuseAnalysis: {
    ...
    success: "Succès",
    noClientSelected: "Aucun patient sélectionné",
    selectClientToView: "Veuillez sélectionner un patient pour voir l'analyse de fraude et d'abus",
    triggering: "Déclenchement...",
    triggerAnalysis: "Déclencher l'Analyse",
  ...
  reportsScreen: {
    ...
    chooseClient: "Choisir un patient...",
    sentiment: "Sentiment",
    medicalAnalysis: "Analyse médicale",
