...
const zh: LocaleTranslations = {
  ...
  fraudAbuseAnalysis: {
    ...
    success: "成功",
    noClientSelected: "未选择患者",
    selectClientToView: "请选择患者以查看欺诈和滥用分析",
    triggering: "触发中...",
  ...
  sentimentAnalysis: {
    ...
    allTime: "全部时间",
    noClientSelected: "未选择患者",
    selectClientToView: "请从主屏幕选择一个患者以查看其情感分析。",
  ...
  medicalAnalysis: {
    ...
    success: "成功",
    noClientSelected: "未选择患者",
    selectClientToView: "请选择一个患者以查看医学分析",
    triggering: "触发中...",
    triggerAnalysis: "触发分析",
