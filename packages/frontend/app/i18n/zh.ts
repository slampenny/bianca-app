...
const zh: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "详情",
    openDetailsHint: "查看此提醒的证据、后续步骤与住户背景信息",
  },
  alertDetail: {
    title: "提醒详情",
    notFound: "此提醒不可用。请返回列表。",
    consentSectionA11y: "该住户的录音同意状态",
    consentHeading: "录音同意",
    consentOnFile: "该住户已有录音同意记录。",
    ...
    relatedAlertsHeading: "该住户的其他提醒",
    openConsentCenter: "打开该住户的同意中心",
  },
  alertActions: {
  ...
  consentCenter: {
    title: "同意中心",
    subtitle: "查看住户与员工的同意记录。可导出含完整性指纹的 CSV 或 PDF 以供审计。",
