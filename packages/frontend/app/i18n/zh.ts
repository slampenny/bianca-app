...
const zh: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "详情",
    openDetailsHint: "查看此提醒的证据、后续步骤与客户背景信息",
  },
  alertDetail: {
    title: "提醒详情",
    notFound: "此提醒不可用。请返回列表。",
    consentSectionA11y: "该客户的录音同意状态",
    consentHeading: "录音同意",
    consentOnFile: "该客户已有录音同意记录。",
    consentMissing: "未记录录音同意。在做出临床或法律假设前请先核实。",
    consentRecordedAt: "记录时间：",
    evidenceHeading: "证据",
    detectorLabel: "来源：",
    confidenceLabel: "模型置信度：",
    detectors: {
      unknown: "未知",
      embedding_pipeline: "语义模型 + 规则",
      phrase_match: "短语匹配",
    },
    viewConversation: "查看对话",
    nextStepsHeading: "建议的后续步骤",
    contextHeading: "客户背景",
    openClient: "打开客户档案",
    openHealthReport: "打开健康分析报告",
    openRiskReport: "打开欺诈与安全报告",
    relatedAlertsHeading: "该客户的其他提醒",
    openConsentCenter: "打开该客户的同意中心",
  },
  alertActions: {
    callEmergencyServices: "如情况需要，请联系紧急服务",
    reviewConversation: "查看近期对话",
    notifyCareTeam: "与护理团队协调",
    documentInRecord: "在记录中记录跟进情况",
    openRiskReport: "查看欺诈与安全分析",
  },
  consentCenter: {
    title: "同意中心",
    subtitle: "查看客户与员工的同意记录。可导出含完整性指纹的 CSV 或 PDF 以供审计。",
    adminOnly: "仅组织管理员可打开同意中心。",
    filterAll: "所有客户",
    filterLabel: "按客户筛选",
    auditScopeLabel: "审计范围",
    scopeSingleOrg: "单个组织",
    scopeAllOrgs: "所有组织",
    orgPickerLabel: "组织",
    pickOrg: "请选择组织以加载审计数据。",
    scopeLabel: "范围：",
    exportCsv: "下载 CSV",
    exportPdf: "下载 PDF",
    exportPdfFileName: "同意审计 (PDF)",
    refreshing: "加载中…",
    empty: "没有符合此筛选条件的同意记录。",
    errorLoad: "无法加载同意记录。",
    rowClient: "客户",
    rowStaff: "员工",
    rowOrganization: "组织：",
  ...
  homeScreen: {
    ...
    glanceHintAlertsBody:
      "您的提醒列表中有多少条与此客户关联（例如对话或日程提醒）。请打开「提醒」标签查看或处理。未关联客户的提醒不计入此处。",
