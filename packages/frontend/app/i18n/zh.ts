...
const zh: LocaleTranslations = {
  ...
  caregiverScreen: {
    ...
    emailPlaceholder: "电子邮件",
    phonePlaceholder: "电话",
    loadingUnassignedPatients: "加载未分配的客户...",
    assigningPatients: "分配客户中...",
    patientsAssignedSuccess: "客户已成功分配！",
  ...
  sentimentAnalysis: {
    ...
    patientSentimentAnalysis: "客户情感分析",
