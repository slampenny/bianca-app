...
const ko: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "세부 정보",
    openDetailsHint: "이 알림의 근거, 다음 단계, 입소자 맥락 열기",
  },
  alertDetail: {
    title: "알림 세부 정보",
    notFound: "이 알림을 사용할 수 없습니다. 목록으로 돌아가세요.",
    consentSectionA11y: "이 입소자의 녹음 동의 상태",
    consentHeading: "녹음 동의",
    consentOnFile: "이 입소자에 대한 동의가 기록되어 있습니다.",
    consentMissing:
    ...
    contextHeading: "입소자 맥락",
    openResident: "입소자 프로필 열기",
    openHealthReport: "건강 분석 보고서 열기",
    openRiskReport: "사기·안전 보고서 열기",
    relatedAlertsHeading: "이 입소자의 다른 알림",
    openConsentCenter: "이 입소자의 동의 센터 열기",
  },
  alertActions: {
  ...
  consentCenter: {
    title: "동의 센터",
    subtitle:
      "입소자와 직원의 동의 기록을 확인하세요. 감사를 위해 무결성 지문이 포함된 CSV 또는 PDF로 보낼 수 있습니다.",
