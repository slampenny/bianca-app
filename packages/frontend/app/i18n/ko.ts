...
const ko: LocaleTranslations = {
  ...
  paymentScreen: {
    ...
    period: "기간:",
    lastDays: "최근 {days}일",
    patientsWithCharges: "요금이 있는 클라이언트:",
    patient: "클라이언트",
    patients: "클라이언트",
  ...
  caregiverScreen: {
    ...
    patientsAssignedSuccess: "클라이언트가 성공적으로 할당되었습니다!",
  ...
  sentimentAnalysis: {
    ...
    allTime: "전체 기간",
    noClientSelected: "선택된 환자가 없습니다",
    selectClientToView: "감정 분석을 보려면 홈 화면에서 환자를 선택하세요.",
    // Dashboard
    patientSentimentAnalysis: "클라이언트 감정 분석",
  ...
  medicalAnalysis: {
    ...
    success: "성공",
    noClientSelected: "선택된 환자가 없습니다",
    selectClientToView: "의료 분석을 보려면 환자를 선택하세요",
    triggering: "트리거 중...",
  ...
  fraudAbuseAnalysis: {
    ...
    error: "오류",
    success: "성공",
    noClientSelected: "선택된 환자 없음",
    selectClientToView: "사기 및 학대 분석을 보려면 환자를 선택하세요",
    triggering: "트리거 중...",
    triggerAnalysis: "분석 트리거",
    loadingResults: "분석 결과 로딩 중...",
