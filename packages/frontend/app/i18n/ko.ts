...
const ko: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "세부 정보",
    openDetailsHint: "이 알림의 근거, 다음 단계, 클라이언트 맥락 열기",
  },
  alertDetail: {
    title: "알림 세부 정보",
    notFound: "이 알림을 사용할 수 없습니다. 목록으로 돌아가세요.",
    consentSectionA11y: "이 클라이언트의 녹음 동의 상태",
    consentHeading: "녹음 동의",
    consentOnFile: "이 클라이언트에 대한 동의가 기록되어 있습니다.",
    consentMissing:
      "녹음 동의 기록이 없습니다. 임상·법적 가정을 하기 전에 확인하세요.",
    consentRecordedAt: "기록:",
    evidenceHeading: "근거",
    detectorLabel: "출처:",
    confidenceLabel: "모델 신뢰도:",
    detectors: {
      unknown: "알 수 없음",
      embedding_pipeline: "의미 모델 + 규칙",
      phrase_match: "구문 일치",
    },
    viewConversation: "대화 보기",
    nextStepsHeading: "권장 다음 단계",
    contextHeading: "클라이언트 맥락",
    openClient: "클라이언트 프로필 열기",
    openHealthReport: "건강 분석 보고서 열기",
    openRiskReport: "사기·안전 보고서 열기",
    relatedAlertsHeading: "이 클라이언트의 다른 알림",
    openConsentCenter: "이 클라이언트의 동의 센터 열기",
  },
  alertActions: {
    callEmergencyServices: "상황에 따라 응급 서비스에 연락하세요",
    reviewConversation: "최근 대화 검토",
    notifyCareTeam: "돌봄 팀과 조율",
    documentInRecord: "기록에 후속 조치 문서화",
    openRiskReport: "사기·안전 분석 검토",
  },
  consentCenter: {
    title: "동의 센터",
    subtitle:
      "클라이언트와 직원의 동의 기록을 확인하세요. 감사를 위해 무결성 지문이 포함된 CSV 또는 PDF로 보낼 수 있습니다.",
    adminOnly: "기관 관리자만 동의 센터를 열 수 있습니다.",
    filterAll: "모든 클라이언트",
    filterLabel: "클라이언트별 필터",
    auditScopeLabel: "감사 범위",
    scopeSingleOrg: "단일 기관",
    scopeAllOrgs: "모든 기관",
    orgPickerLabel: "기관",
    pickOrg: "감사를 불러오려면 기관을 선택하세요.",
    scopeLabel: "범위:",
    exportCsv: "CSV 다운로드",
    exportPdf: "PDF 다운로드",
    exportPdfFileName: "동의 감사 (PDF)",
    refreshing: "불러오는 중…",
    empty: "이 필터와 일치하는 동의 기록이 없습니다.",
    errorLoad: "동의 기록을 불러올 수 없습니다.",
    rowClient: "클라이언트",
    rowStaff: "직원",
    rowOrganization: "기관:",
    rowType: "유형",
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "클라이언트 온보딩",
    onboardingNotStarted: "시작 전 — 다음: 4일 중 1일차",
    onboardingInProgress: "진행 중",
    onboardingNextDay: "다음: 4일 중 {{day}}일차",
    onboardingCallsCompleted: "4통화 중 {{completed}}통 완료",
