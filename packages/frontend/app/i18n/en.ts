const en = {
  alertScreen: {
    ...
    openDetails: "Details",
    openDetailsHint: "Open evidence, next steps, and resident context for this alert",
  },
  alertDetail: {
    title: "Alert details",
    notFound: "This alert is not available. Go back to the list.",
    consentSectionA11y: "Recording consent status for this resident",
    consentHeading: "Recording consent",
    consentOnFile: "Consent is on file for this resident.",
    ...
    contextHeading: "Resident context",
    openResident: "Open resident profile",
    openHealthReport: "Open health analysis report",
    openRiskReport: "Open fraud & safety report",
    relatedAlertsHeading: "Other alerts for this resident",
    openConsentCenter: "Open consent center for this resident",
  },
  alertActions: {
  ...
  consentCenter: {
    ...
    subtitle:
      "Review consent records for residents and staff. Export CSV or a PDF with an integrity fingerprint for audits.",
    adminOnly: "Only organization administrators can open the consent center.",
    filterAll: "All residents",
    filterLabel: "Filter by resident",
