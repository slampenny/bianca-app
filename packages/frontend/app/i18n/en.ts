const en = {
  ...
  onboarding: {
    ...
    howItWorks: {
      ...
      organization: "Add your clients, set when Bianca should call them, and review conversations and reports in one place. Bianca handles the calls so you can focus on care.",
