const en = {
  alertScreen: {
    ...
    openDetails: "Details",
    openDetailsHint: "Open evidence, next steps, and client context for this alert",
  },
  alertDetail: {
    title: "Alert details",
    notFound: "This alert is not available. Go back to the list.",
    consentSectionA11y: "Recording consent status for this client",
    consentHeading: "Recording consent",
    consentOnFile: "Consent is on file for this client.",
    consentMissing: "No recording consent flag is on file. Verify before acting on clinical or legal assumptions.",
    ...
    detectors: {
      unknown: "Unknown",
      embedding_pipeline: "Semantic model + rules",
      phrase_match: "Phrase match",
    },
    viewConversation: "View conversations",
    nextStepsHeading: "Suggested next steps",
    contextHeading: "Client context",
    openClient: "Open client profile",
    openHealthReport: "Open health analysis report",
    openRiskReport: "Open fraud & safety report",
    relatedAlertsHeading: "Other alerts for this client",
    openConsentCenter: "Open consent center for this client",
    resolutionHeading: "Resolution",
    resolutionSummary:
      "Resolved by {{name}} on {{date}}. {{resolution}}",
    resolutionNoteLabel: "How was this resolved?",
    resolutionPlaceholder: "Describe what you did…",
    markResolved: "Mark as resolved",
    resolveError: "Could not save resolution.",
    alreadyResolved: "This alert is already marked resolved.",
  },
  alertActions: {
    callEmergencyServices: "Contact emergency services if the situation requires it",
    reviewConversation: "Review the recent conversation",
    notifyCareTeam: "Coordinate with your care team",
    documentInRecord: "Document follow-up in your records",
    openRiskReport: "Review fraud & safety analysis",
  },
  consentCenter: {
    title: "Consent center",
    subtitle:
      "Review consent records for clients and staff. Export CSV or a PDF with an integrity fingerprint for audits.",
    adminOnly: "Only organization administrators can open the consent center.",
    filterAll: "All clients",
    filterLabel: "Filter by client",
    auditScopeLabel: "Audit scope",
    scopeSingleOrg: "One organization",
    scopeAllOrgs: "All organizations",
    orgPickerLabel: "Organization",
    pickOrg: "Select an organization to load the audit.",
    scopeLabel: "Scope:",
    exportCsv: "Download CSV",
    exportPdf: "Download PDF",
    exportPdfFileName: "Consent audit (PDF)",
    refreshing: "Loading…",
    empty: "No consent records match this filter.",
    errorLoad: "Could not load consent records.",
    rowClient: "Client",
    rowStaff: "Staff",
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "Client onboarding",
  ...
  callScreen: {
    ...
    onboardingThisCall:
      "This call is onboarding session {{day}} of 4. The journey advances when the client answers and the session completes.",
  ...
  homeScreen: {
    ...
    glanceHintAlertsBody:
      "How many alerts in your list are linked to this client (for example conversation or schedule alerts). Open the Alerts tab to read or manage them. Alerts with no linked client are not counted here.",
...
**Español**: Si necesita ayuda, comuníquese con privacy@biancawellness.com`,
  ...
  profileScreen: {
    ...
    consentCenter: "Consent center (organization)",
