...
const it: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetailsHint: "Apri evidenze, passi successivi e contesto del residente per questo avviso",
  },
  alertDetail: {
    title: "Dettagli avviso",
    notFound: "Questo avviso non è disponibile. Torna all’elenco.",
    consentSectionA11y: "Stato del consenso alla registrazione per questo residente",
    consentHeading: "Consenso alla registrazione",
    consentOnFile: "È presente un consenso per questo residente.",
    consentMissing:
    ...
    contextHeading: "Contesto del residente",
    openResident: "Apri profilo residente",
    openHealthReport: "Apri rapporto analisi salute",
    openRiskReport: "Apri rapporto frode e sicurezza",
    relatedAlertsHeading: "Altri avvisi per questo residente",
    openConsentCenter: "Apri il centro consensi per questo residente",
  },
  alertActions: {
  ...
  consentCenter: {
    ...
    subtitle:
      "Consulta i record di consenso di residenti e personale. Esporta CSV o PDF con impronta di integrità per le verifiche.",
    adminOnly: "Solo gli amministratori dell’organizzazione possono aprire il centro consensi.",
    filterAll: "Tutti i residenti",
    filterLabel: "Filtra per residente",
