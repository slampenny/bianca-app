...
const it: LocaleTranslations = {
  ...
  conversationsScreen: {
    ...
    noClientSelected: "Nessun paziente selezionato",
  ...
  fraudAbuseAnalysis: {
    ...
    success: "Successo",
    noClientSelected: "Nessun paziente selezionato",
    selectClientToView: "Seleziona un paziente per visualizzare l'analisi di frode e abuso",
    ...
    insufficientDataWarning: "Dati limitati disponibili: {{current}} chiamata(e) analizzata(e). Per un'analisi più affidabile, si raccomandano {{minimum}} o più chiamate in un periodo più lungo per comprendere meglio i modelli del paziente.",
  ...
  reportsScreen: {
    ...
    chooseClient: "Scegli un paziente...",
  ...
  caregiverScreen: {
    ...
    patientsAssignedSuccess: "Clienti assegnati con successo!",
  ...
  sentimentAnalysis: {
    ...
    noClientSelected: "Nessun paziente selezionato",
    selectClientToView: "Per favore seleziona un paziente dalla schermata home per visualizzare la sua analisi dei sentimenti.",
    patientSentimentAnalysis: "Analisi sentimenti cliente",
    ...
    clientMoodAssessment: "Valutazione umore paziente",
  ...
  medicalAnalysis: {
    ...
    success: "Successo",
    noClientSelected: "Nessun paziente selezionato",
    selectClientToView: "Per favore seleziona un paziente per visualizzare l'analisi medica",
    triggering: "Attivazione...",
    triggerAnalysis: "Attiva analisi",
