...
const it: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetailsHint: "Apri evidenze, passi successivi e contesto del cliente per questo avviso",
  },
  alertDetail: {
    title: "Dettagli avviso",
    notFound: "Questo avviso non è disponibile. Torna all’elenco.",
    consentSectionA11y: "Stato del consenso alla registrazione per questo cliente",
    consentHeading: "Consenso alla registrazione",
    consentOnFile: "È presente un consenso per questo cliente.",
    consentMissing:
      "Nessun consenso alla registrazione in archivio. Verifica prima di assumere implicazioni cliniche o legali.",
    consentRecordedAt: "Registrato:",
    evidenceHeading: "Evidenze",
    detectorLabel: "Origine:",
    confidenceLabel: "Confidenza del modello:",
    detectors: {
      unknown: "Sconosciuto",
      embedding_pipeline: "Modello semantico + regole",
      phrase_match: "Corrispondenza di frase",
    },
    viewConversation: "Vedi conversazioni",
    nextStepsHeading: "Passi successivi suggeriti",
    contextHeading: "Contesto del cliente",
    openClient: "Apri profilo cliente",
    openHealthReport: "Apri rapporto analisi salute",
    openRiskReport: "Apri rapporto frode e sicurezza",
    relatedAlertsHeading: "Altri avvisi per questo cliente",
    openConsentCenter: "Apri il centro consensi per questo cliente",
  },
  alertActions: {
    callEmergencyServices: "Contatta i servizi di emergenza se la situazione lo richiede",
    reviewConversation: "Rivedi la conversazione recente",
    notifyCareTeam: "Coordina con il team di assistenza",
    documentInRecord: "Documenta il follow-up nei tuoi registri",
    openRiskReport: "Rivedi l’analisi frode e sicurezza",
  },
  consentCenter: {
    title: "Centro consensi",
    subtitle:
      "Consulta i record di consenso di clienti e personale. Esporta CSV o PDF con impronta di integrità per le verifiche.",
    adminOnly: "Solo gli amministratori dell’organizzazione possono aprire il centro consensi.",
    filterAll: "Tutti i clienti",
    filterLabel: "Filtra per cliente",
    auditScopeLabel: "Ambito della verifica",
    scopeSingleOrg: "Un’organizzazione",
    scopeAllOrgs: "Tutte le organizzazioni",
    orgPickerLabel: "Organizzazione",
    pickOrg: "Seleziona un’organizzazione per caricare la verifica.",
    scopeLabel: "Ambito:",
    exportCsv: "Scarica CSV",
    exportPdf: "Scarica PDF",
    exportPdfFileName: "Verifica consensi (PDF)",
    refreshing: "Caricamento…",
    empty: "Nessun record di consenso corrisponde a questo filtro.",
    errorLoad: "Impossibile caricare i record di consenso.",
    rowClient: "Cliente",
    rowStaff: "Personale",
    rowOrganization: "Organizzazione:",
    rowType: "Tipo",
    rowGranted: "Concesso",
    rowMethod: "Metodo",
    rowRecorded: "Registrato",
    rowVia: "Tramite",
    yes: "Sì",
    no: "No",
    exportFileName: "Verifica consensi",
  },
  legalLinks: {
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "Onboarding del cliente",
    ...
    onboardingButtonA11yHint: "Apre le risposte e i dettagli dell’onboarding per questo cliente.",
  },
  ...
  profileScreen: {
    ...
    consentCenter: "Centro consensi (organizzazione)",
