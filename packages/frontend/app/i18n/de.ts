...
const de: LocaleTranslations = {
  ...
  alertDetail: {
    ...
    consentSectionA11y: "Aufzeichnungseinwilligungsstatus für diesen Bewohner",
    consentHeading: "Aufzeichnungseinwilligung",
    consentOnFile: "Für diesen Bewohner liegt eine Einwilligung vor.",
    consentMissing:
    ...
    contextHeading: "Bewohnerkontext",
    openResident: "Bewohnerprofil öffnen",
    openHealthReport: "Gesundheitsanalyse öffnen",
    openRiskReport: "Betrugs- & Sicherheitsbericht öffnen",
    relatedAlertsHeading: "Weitere Hinweise für diesen Bewohner",
    openConsentCenter: "Einwilligungszentrale für diesen Bewohner öffnen",
  },
  alertActions: {
  ...
  consentCenter: {
    ...
    subtitle:
      "Prüfen Sie Einwilligungsdatensätze von Bewohnerinnen, Bewohnern und Personal. Exportieren Sie CSV oder PDF mit Integritäts-Fingerprint für Audits.",
    adminOnly: "Nur Organisationsadministratorinnen und -administratoren können die Einwilligungszentrale öffnen.",
    filterAll: "Alle Bewohnerinnen und Bewohner",
    filterLabel: "Nach Bewohner filtern",
    ...
    rowResident: "Bewohnerin / Bewohner",
    rowStaff: "Personal",
