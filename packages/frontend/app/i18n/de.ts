...
const de: LocaleTranslations = {
  ...
  conversationsScreen: {
    ...
    noClientSelected: "Kein Patient ausgewählt",
  ...
  clientScreen: {
    ...
    updateClient: "PATIENT AKTUALISIEREN",
    createClient: "PATIENT ERSTELLEN",
  ...
  paymentScreen: {
    ...
    patients: "Klienten",
    patient: "Klient",
    chargesByPatient: "Gebühren nach Klient",
  ...
  fraudAbuseAnalysis: {
    ...
    success: "Erfolg",
    noClientSelected: "Kein Patient ausgewählt",
    selectClientToView: "Bitte wählen Sie einen Patienten aus, um die Betrugs- und Missbrauchsanalyse anzuzeigen",
    triggering: "Auslösen...",
    ...
    insufficientDataWarning: "Begrenzte Daten verfügbar: {{current}} Anruf(e) analysiert. Für eine zuverlässigere Analyse werden {{minimum}} oder mehr Anrufe über einen längeren Zeitraum empfohlen, um die Patientenmuster besser zu verstehen.",
  ...
  reportsScreen: {
    ...
    chooseClient: "Wähle einen Patienten...",
  ...
  sentimentAnalysis: {
    ...
    allTime: "Gesamtzeit",
    noClientSelected: "Kein Patient ausgewählt",
    selectClientToView: "Bitte wähle einen Patienten vom Startbildschirm aus, um seine Stimmungsanalyse anzuzeigen.",
    patientSentimentAnalysis: "Klienten-Stimmungsanalyse",
    ...
    clientMoodAssessment: "Patientenstimmungsbewertung",
  ...
  medicalAnalysis: {
    ...
    success: "Erfolg",
    noClientSelected: "Kein Patient ausgewählt",
    selectClientToView: "Bitte wähle einen Patienten aus, um die medizinische Analyse anzuzeigen",
    triggering: "Auslösen...",
    triggerAnalysis: "Analyse auslösen",
    loadingResults: "Lade Analyseergebnisse...",
    noResultsAvailable: "Keine Analyseergebnisse verfügbar",
