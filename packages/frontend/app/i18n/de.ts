...
const de: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    openDetails: "Details",
    openDetailsHint: "Evidenz, nächste Schritte und Klientenkontext zu diesem Hinweis anzeigen",
  },
  alertDetail: {
    title: "Hinweisdetails",
    notFound: "Dieser Hinweis ist nicht verfügbar. Zurück zur Liste.",
    consentSectionA11y: "Aufzeichnungseinwilligungsstatus für diesen Klienten",
    consentHeading: "Aufzeichnungseinwilligung",
    consentOnFile: "Für diesen Klienten liegt eine Einwilligung vor.",
    consentMissing:
      "Keine Aufzeichnungseinwilligung hinterlegt. Vor klinischen oder rechtlichen Annahmen prüfen.",
    consentRecordedAt: "Erfasst:",
    evidenceHeading: "Evidenz",
    detectorLabel: "Quelle:",
    confidenceLabel: "Modellvertrauen:",
    detectors: {
      unknown: "Unbekannt",
      embedding_pipeline: "Semantikmodell + Regeln",
      phrase_match: "Phrasenabgleich",
    },
    viewConversation: "Gespräche anzeigen",
    nextStepsHeading: "Vorgeschlagene nächste Schritte",
    contextHeading: "Klientenkontext",
    openClient: "Klientenprofil öffnen",
    openHealthReport: "Gesundheitsanalyse öffnen",
    openRiskReport: "Betrugs- & Sicherheitsbericht öffnen",
    relatedAlertsHeading: "Weitere Hinweise für diesen Klienten",
    openConsentCenter: "Einwilligungszentrale für diesen Klienten öffnen",
  },
  alertActions: {
    callEmergencyServices: "Bei Bedarf Rettungsdienste kontaktieren",
    reviewConversation: "Aktuelles Gespräch prüfen",
    notifyCareTeam: "Mit dem Pflegeteam abstimmen",
    documentInRecord: "Nachverfolgung in den Akten dokumentieren",
    openRiskReport: "Betrugs- & Sicherheitsanalyse prüfen",
  },
  consentCenter: {
    title: "Einwilligungszentrale",
    subtitle:
      "Prüfen Sie Einwilligungsdatensätze von Klientinnen, Klienten und Personal. Exportieren Sie CSV oder PDF mit Integritäts-Fingerprint für Audits.",
    adminOnly: "Nur Organisationsadministratorinnen und -administratoren können die Einwilligungszentrale öffnen.",
    filterAll: "Alle Klientinnen und Klienten",
    filterLabel: "Nach Klient filtern",
    auditScopeLabel: "Auditumfang",
    scopeSingleOrg: "Eine Organisation",
    scopeAllOrgs: "Alle Organisationen",
    orgPickerLabel: "Organisation",
    pickOrg: "Wählen Sie eine Organisation, um das Audit zu laden.",
    scopeLabel: "Umfang:",
    exportCsv: "CSV herunterladen",
    exportPdf: "PDF herunterladen",
    exportPdfFileName: "Einwilligungsaudit (PDF)",
    refreshing: "Wird geladen…",
    empty: "Keine Einwilligungsdatensätze für diesen Filter.",
    errorLoad: "Einwilligungsdatensätze konnten nicht geladen werden.",
    rowClient: "Klient",
    rowStaff: "Personal",
    rowOrganization: "Organisation:",
    rowType: "Typ",
    rowGranted: "Erteilt",
    rowMethod: "Methode",
    rowRecorded: "Erfasst",
    ...
    yes: "Ja",
    no: "Nein",
    exportFileName: "Einwilligungsaudit",
  },
  legalLinks: {
  ...
  homeScreen: {
    ...
    glanceHintAlertsBody:
      "Wie viele Hinweise in Ihrer Liste mit diesem Klienten verknüpft sind (z. B. Gesprächs- oder Termin-Hinweise). Öffnen Sie den Tab „Benachrichtigungen“, um sie zu lesen oder zu verwalten. Hinweise ohne verknüpften Klienten werden hier nicht gezählt.",
  ...
  headers: {
    ...
    consentCenter: "Einwilligungszentrale",
    termsOfService: "Nutzungsbedingungen",
  ...
  clientScreen: {
    ...
    onboardingCardTitle: "Klienten-Einführung",
  ...
  profileScreen: {
    ...
    consentCenter: "Einwilligungszentrale (Organisation)",
