...
describe("alertApi", () => {
  ...
  it("should get all alerts", async () => {
    const result = await alertApi.endpoints.getAllAlerts.initiate()(
      store.dispatch,
      store.getState,
      {},
    )
  ...
  it("should get an alert", async () => {
    const result = await alertApi.endpoints.getAlert.initiate({ alertId })(
      store.dispatch,
      store.getState,
      {},
    )
  ...
  it("should update an alert", async () => {
    ...
    const result = await alertApi.endpoints.updateAlert.initiate({ alertId, alert: updatedAlert })(
      store.dispatch,
      store.getState,
      {},
    )
  ...
  it("should delete an alert", async () => {
    ...
    const result = await alertApi.endpoints.deleteAlert.initiate({
      alertId: responseAlert.id as string,
  ...
  it("should mark an alert as read", async () => {
    const result = await alertApi.endpoints.markAlertAsRead.initiate({ alertId })(
      store.dispatch,
      store.getState,
      {},
    )
