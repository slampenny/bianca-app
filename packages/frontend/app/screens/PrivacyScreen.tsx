...
* **Client/Recipient Information:** If you use the App to initiate calls to another person (e.g., a family member or client — the "Recipient"), you may provide their name and phone number. **You represent and warrant that you have obtained all necessary consents from the Recipient to provide their information to us and for us to contact them via the App's Services.**
...
* **With Your Consent / At Your Direction:** We may share your information (including call data, recordings, transcriptions, summaries) with other users or third parties when you explicitly consent or direct us to do so through the App's functionality (e.g., a family member sharing results, a care facility sharing information according to their policies and client agreements).
...
* **Your Responsibility:**
    ...
    * **If you are an organizational user (e.g., retirement home):** You are responsible for obtaining all necessary consents from your clients and/or their legal representatives, in accordance with applicable laws (including privacy and health information laws) and your own policies, before using the App to call and record/transcribe interactions with them. You agree to indemnify us for any failure to obtain such necessary consents.
...
export const PrivacyScreen = () => {
  ...
  const policyContent = useMemo(() => {
    ...
    if (country === 'CA') {
      ...
      return translate("privacyScreen.pipedaContent") || PRIVACY_MD_PIPEDA
    } else if (country === 'US') {
