const en = {
  ...
  loginScreen: {
    ...
    devSeedHint: "Local dev: {{email}} / {{password}} (run yarn seed if login fails)",
  },
  logoutScreen: {
    logoutButton: "Logout",
  ...
  conversationsScreen: {
    ...
    standardQuestionsTitle: "Standard questions",
    standardQuestionNotAnswered: "Not answered",
  },
  clientScreen: {
    nameLabel: "Name",
    ...
    phoneLabel: "Phone",
    phonePlaceholder: "Number Bianca will call",
    preferredLanguageLabel: "Preferred language",
    updateClient: "Save changes",
    createClient: "Add loved one",
    whenBiancaCalls: "When Bianca calls",
    callHistory: "Call history",
    editDetails: "Edit details",
    removeLovedOne: "Remove loved one",
    manageSchedules: "When Bianca calls",
    manageConversations: "Call history",
    viewSentimentAnalysis: "View wellness details",
    manageCaregivers: "Manage caregivers",
    confirmDelete: "Tap again to confirm",
    deleteClient: "Remove loved one",
  ...
  orgScreen: {
    ...
    requiredQuestionsTitle: "Standard call questions",
    requiredQuestionsHelper:
      "Bianca asks these on every wellness call after pleasantries. She asks only the question — not which medication or clinical details.",
    enableRequiredQuestionsLabel: "Ask standard questions on every call",
    requiredQuestionPromptPlaceholder: "e.g. Have you taken your medication today?",
    addRequiredQuestion: "Add question",
    removeRequiredQuestion: "Remove",
    voiceOnboardingTitle: "Resident voice onboarding",
    voiceOnboardingHelper:
      "Customize the multi-day call sequence and questions Bianca uses when welcoming new residents.",
    configureVoiceOnboarding: "Configure onboarding questions",
  },
  voiceOnboardingScreen: {
    intro:
      "The built-in default is a {{days}}-day plan. You can review and customize each day's theme, opening, and questions.",
    disabledBanner: "Onboarding is disabled. New residents will receive regular wellness calls only.",
    defaultBanner: "Using the built-in {{days}}-day plan. Edit below to save a custom plan for your organization.",
    customBanner: "Custom plan — changes apply only to your organization.",
    viewOnly: "Only an org admin can edit voice onboarding.",
    useDefaultLabel: "Use built-in default plan",
    addDay: "Add day",
    resetDefault: "Reset to default",
    disable: "Disable onboarding",
    reEnableDefault: "Re-enable with default plan",
    dayLabel: "Day {{day}}",
    ...
    questionId: "Id: {{id}}",
    promptLabel: "What Bianca asks",
    compressionPriorityLabel: "Priority if call runs long",
    removeQuestion: "Remove question",
    addQuestion: "Add question",
    save: "Save onboarding plan",
    saving: "Saving…",
    saveError: "Could not save. Each day needs at least one question with a unique id.",
  },
  caregiverScreen: {
    nameLabel: "Name",
  ...
  signupScreen: {
    ...
    familyTitle: "Set up family access",
    familySubtitle:
      "Create a password to view schedules, call history, and weekly updates for your loved one in the Bianca app.",
  ...
  homeScreen: {
    statusAllOk: "Everything looks good",
    statusAllOkSubtitle: "No unread alerts right now.",
    statusAlertsTitle: "{{count}} alerts need attention",
    statusAlertsSubtitle: "Tap to review your alerts.",
    statusAlertsActionHint: "Opens the alerts tab",
    ...
    glanceSentimentActionHint: "Opens wellness details for the latest check-in in Insights.",
    glanceHealthActionHint: "Opens the wellness check summary in Insights.",
    glanceRiskActionHint: "Opens safety concerns in Insights.",
  ...
  onboarding: {
    ...
    termsAndConsent: {
      ...
      whyImportantBody: "Call recording laws vary by state and country. In single-consent (one-party) states, only one person needs to agree to recording. In two-party states, everyone on the call must consent.",
      yes: "Yes",
      no: "No",
      saveAndContinue: "Save and continue",
    },
    addLovedOne: {
      title: "Who are you checking on?",
      subtitle: "Add someone you love so Bianca can call them for wellness check-ins.",
      nameLabel: "Their name",
      namePlaceholder: "e.g. Eleanor",
      relationshipLabel: "Your relationship (optional)",
      relationshipPlaceholder: "e.g. Mom, Dad, spouse",
      phoneLabel: "Their phone number",
      phonePlaceholder: "Number Bianca will call",
      requiredFields: "Name and phone number are required.",
      createFailed: "Could not add your loved one. Please try again.",
      skipForNow: "Skip for now",
      relationshipNote: "Relationship: {{relationship}}",
    },
    schedule: {
      title: "When should Bianca call?",
      subtitle: "Pick a time that works for regular check-ins. You can change this anytime.",
      timeRequired: "Please choose a call time.",
      saveFailed: "Could not save the schedule. Please try again.",
...
**Español**: Si necesita ayuda, comuníquese con privacy@biancawellness.com`,
  ...
  headers: {
    ...
    payments: "Payments",
    reports: "Insights",
    sentimentAnalysis: "Wellness details",
    clientOnboarding: "Getting started",
    medicalAnalysis: "Wellness check",
    fraudAbuseAnalysis: "Safety concerns",
    privacyPolicy: "Privacy Policy",
    privacyPractices: "HIPAA Privacy Practices",
  ...
  reportsScreen: {
    intro: "See how your loved one is doing based on Bianca's check-in calls.",
    primarySection: "Wellness",
    secondarySection: "More details",
    selectClient: "Who are you viewing?",
    chooseClient: "Choose someone...",
    sentiment: "How they're doing",
    sentimentHint: "Mood and tone from recent calls",
    medicalAnalysis: "Wellness check",
    medicalHint: "Health-related topics from conversations",
    fraudAbuseAnalysis: "Safety concerns",
    fraudHint: "Signs of scams, isolation, or neglect",
    comingSoon: "More insights coming soon",
    modalTitle: "Choose someone",
    modalCancel: "Cancel",
  },
  familyInviteWelcome: {
    title: "You're all set",
    body: "Use the Bianca app to view schedules, call history, and weekly wellness updates for your loved one.",
    appStore: "Download on the App Store",
    googlePlay: "Get it on Google Play",
    continueInBrowser: "Continue in browser",
    continueInApp: "Continue to Bianca",
    skipForNow: "Skip for now",
  },
  familyDigests: {
    title: "Weekly updates",
    detailTitle: "Weekly update",
    intro: "Read weekly summaries from Bianca's check-in calls.",
    sectionTitle: "Weekly updates",
    listHint: "Summaries emailed to your family each week",
    selectClient: "Choose a resident to view weekly updates.",
    loadError: "Could not load weekly updates. Please try again.",
    empty: "No weekly updates yet.",
    weekAtAGlance: "Week at a glance",
    callsSummary: "{{placed}} calls placed, {{answered}} answered",
    connected: "Connected",
    missed: "Missed",
  },
  schedulesScreen: {
    scheduleDetails: "When Bianca calls",
    selectSchedule: "Choose a schedule:",
    scheduleNumber: "Schedule",
    newSchedule: "Add another schedule",
    noSchedulesAvailable: "Set when Bianca should call below. You can change this anytime.",
    errorLoadingSchedules: "Could not load call schedule.",
    invalidScheduleError: "Please choose a frequency, time, and days (for weekly or monthly calls).",
    errorSavingSchedule: "Could not save the schedule. Please try again.",
  },
  themes: {
    healthcare: {
      name: "Healthcare",
