...
tcp:9090 من جهازك الطرفي ، واعد تحميل التطبيق`,
  ...
  clientScreen: {
    ...
    onboardingNotStarted: "لم يبدأ — التالي: اليوم 1 من {{total}}",
    onboardingInProgress: "قيد التنفيذ",
    onboardingNextDay: "التالي: اليوم {{day}} من {{total}}",
    onboardingCallsCompleted: "{{completed}} من {{total}} مكالمات مكتملة",
