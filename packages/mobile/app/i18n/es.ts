...
const es: LocaleTranslations = {
  alertScreen: {
    ...
    noAlertsForFilteredClientSubtitle: "No hay alertas vinculadas a {{name}}. Quita el filtro para ver todas las alertas u elige otro cliente en Inicio.",
  },
  errorScreen: {
  ...
  emailVerificationScreen: {
    ...
    errorNetwork: "No se puede conectar al servidor. Comprueba tu conexión a internet e inténtalo de nuevo.",
    errorNoToken: "Falta el token de verificación",
    errorVerificationFailed: "Error en la verificación del correo",
    verificationFailed: "Error en la verificación del correo",
  ...
  conversationsScreen: {
    ...
    firstConversation: "No se encontraron conversaciones previas. Esta será la primera conversación con este cliente.",
    noConversationsToDisplay: "No hay conversaciones para mostrar",
    noPreviousConversations: "No se encontraron conversaciones previas para este cliente",
  ...
  clientScreen: {
    ...
    updateClient: "ACTUALIZAR PACIENTE",
    createClient: "CREAR PACIENTE",
    ...
    deleteClient: "ELIMINAR PACIENTE",
    onboardingCardTitle: "Incorporación del residente",
    onboardingNotStarted: "No iniciada — siguiente: Día 1 de {{total}}",
    onboardingInProgress: "En curso",
    onboardingNextDay: "Siguiente: Día {{day}} de {{total}}",
    onboardingCallsCompleted: "{{completed}} de {{total}} llamadas completadas",
    ...
    onboardingOutboundCallsHint: "Las llamadas salientes desde Inicio o el horario usan la conversación de incorporación de la sesión {{day}} hasta que esa sesión se complete por teléfono. Sin respuesta no hay progreso: la siguiente llamada permanece en la misma sesión.",
  },
  clientOnboardingScreen: {
    title: "Respuestas de incorporación",
    noClient: "Ningún cliente seleccionado.",
    day: "Día",
    ...
    signalsForDay: "Señales registradas el día {{day}}",
  },
  paymentScreen: {
    paid: "Pagado",
    pending: "Pendiente",
    ...
    day: "día",
    days: "días",
    clientsWithCharges: "Clientes con cargos:",
    clientWord: "cliente",
    clientsWord: "clientes",
    chargesByClient: "Cargos por cliente",
  ...
  orgScreen: {
    ...
    alertOnAllMissedCallsHelper: "Enviar alertas por cada llamada perdida e intento de reintento",
    alertOnAllMissedCallsLabel: "Alertar en todas las llamadas perdidas",
    callRetrySettings: "Configuración de reintentos de llamada",
    clientConsentSettings: "Configuración de consentimiento del cliente",
    country: "País",
    countryHelper: "Selecciona el país de tu organización. Esto ayuda a determinar las normativas de privacidad aplicables.",
    enableRetriesHelper: "Cuando está activado, el sistema reintentará automáticamente las llamadas fallidas",
    enableRetriesLabel: "Activar reintentos de llamada",
    retryCountHelper: "Número de veces que se reintentará una llamada si no se contesta (1-5)",
    retryCountLabel: "Número de reintentos",
    retryIntervalMinutesHelper: "Tiempo de espera entre intentos de reintento (1-60 minutos, predeterminado: 15)",
    retryIntervalMinutesLabel: "Intervalo de reintento (minutos)",
    timezone: "Zona horaria",
    timezoneHelper: "Selecciona la zona horaria de tu organización. Los horarios del calendario se basarán en esta zona horaria.",
    requireClientConsentLabel: "Requerir consentimiento del cliente",
    requireClientConsentHelper: "Si está activado, las solicitudes de consentimiento se enviarán automáticamente por correo.",
  },
  caregiverScreen: {
    namePlaceholder: "Nombre",
    emailPlaceholder: "Correo electrónico",
    phonePlaceholder: "Teléfono",
    loadingUnassignedClients: "Cargando clientes sin asignar...",
    assigningClients: "Asignando clientes...",
    clientsAssignedSuccess: "¡Clientes asignados exitosamente!",
    loadingCaregivers: "Cargando cuidadores...",
    assignSelected: "Asignar seleccionados",
    assignUnassignedClients: "Asignar clientes sin asignar",
    assignUnassignedClientsTitle: "Asignar clientes sin asignar",
    confirmDelete: "CONFIRMAR ELIMINACIÓN",
    ...
    invite: "INVITAR",
    nameLabel: "Nombre",
    noUnassignedClientsFound: "No se encontraron clientes sin asignar.",
    phoneLabel: "Teléfono",
    save: "GUARDAR",
  ...
  confirmResetScreen: {
    ...
    codeFieldPlaceholder: "Ingrese el código",
    newPasswordFieldLabel: "Nueva contraseña",
    newPasswordFieldPlaceholder: "Ingrese la nueva contraseña",
    confirmPasswordFieldLabel: "Confirmar nueva contraseña",
    confirmPasswordFieldPlaceholder: "Confirme la contraseña",
    confirmReset: "Confirmar restablecimiento",
    successTitle: "¡Contraseña restablecida!",
    successMessage: "Su contraseña se actualizó correctamente. Ya puede iniciar sesión con la nueva contraseña.",
    redirecting: "Redirigiendo al inicio de sesión...",
    resetPasswordButton: "Restablecer contraseña",
    backToLogin: "Volver al inicio de sesión",
    successMessageShort: "¡Contraseña restablecida con éxito!",
    requestFailed: "Error al restablecer. Verifique el código e intente de nuevo.",
  },
  homeScreen: {
    welcome: "Bienvenido, {{name}}",
    guest: "Invitado",
    addClient: "Agregar cliente",
    adminOnlyMessage: "Solo los administradores de organización y super administradores pueden agregar clientes",
    ...
    lastAnsweredCall: "Última llamada atendida",
    neverCalled: "Nunca",
    noAnsweredCallsYet: "Sin llamadas atendidas aún",
    glanceNoData: "—",
    ...
    glanceHintButtonA11y: "Acerca de {{label}}",
    glanceHintSentimentTitle: "Tendencia del ánimo",
    glanceHintSentimentBody: "Resumen del tono del cliente en llamadas analizadas recientes (unos 30 días). Alza, estable o baja compara llamadas más nuevas con otras un poco más antiguas. No es un diagnóstico; usa el informe de sentimiento completo para más detalle.",
    glanceHintHealthTitle: "Puntuación de salud",
    glanceHintHealthBody: "Puntuación general del último análisis médico de conversaciones (0–100, más alto es mejor). Combina señales como patrones cognitivos y de estado de ánimo en las llamadas. No sustituye el criterio clínico ni el informe de salud completo.",
    glanceHintRiskTitle: "Puntuación de riesgo",
    glanceHintRiskBody: "Puntuación global del último análisis de fraude y seguridad (0–100, más alto indica más preocupación). Refleja patrones en lo dicho sobre dinero, seguridad, aislamiento y temas similares. Consulta el informe de fraude y abuso para detalles.",
    ...
    glanceHintAlertsBody: "Cuántas alertas de tu lista están vinculadas a este residente (por ejemplo alertas de cliente, conversación u horario). Abre la pestaña Alertas para leerlas o gestionarlas. Las alertas sin cliente vinculado no se cuentan aquí.",
  ...
  headers: {
    ...
    clientOnboarding: "Incorporación",
    ...
    register: "Registrarse",
    privacyRequest: "Solicitar mis datos",
  },
  scheduleScreen: {
  ...
  sentimentAnalysis: {
    ...
    sessionRequiredMessage: "Tu sesión puede haber expirado. Vuelve a iniciar sesión para ver el análisis de sentimientos. Si ya ves la ventana de inicio de sesión, complétala allí.",
    signInToContinueButton: "Iniciar sesión",
    accessDeniedTitle: "No se puede cargar este informe",
    accessDeniedMessage: "Es posible que no tengas acceso a los datos de sentimiento de este cliente o que tus permisos hayan cambiado. Prueba a elegir de nuevo al cliente en Inicio o contacta a un administrador.",
    ...
    noSentimentDataMessage: "El análisis de sentimientos aparecerá aquí una vez que el cliente haya completado conversaciones.",
    ...
    moreEmotions: "más",
    clientMood: "Estado de ánimo del cliente:",
    ...
    clientMoodAssessment: "Evaluación del estado de ánimo del cliente",
    concernLevel: "Nivel de preocupación",
    lowConcernDescription: "El cliente parece estar de buen ánimo con preocupaciones mínimas.",
    ...
    pleaseSelectClient: "Por favor selecciona un cliente primero",
    ...
    noRecentCallButHaveCalls: "Llamadas recientes, aún sin sentimiento",
    noRecentCallButHaveCallsMessage: "Tienes llamadas recientes en los últimos 30 días, pero ninguna tiene análisis de sentimientos aún. Las nuevas llamadas se analizarán automáticamente al terminar. Las antiguas pueden necesitar reprocesarse.",
  },
  medicalAnalysis: {
    ...
    success: "Éxito",
    noClientSelected: "Ningún cliente seleccionado",
    selectClientToView: "Por favor selecciona un cliente para ver el análisis médico",
    ...
    insufficientDataWarning: "Datos limitados disponibles: {{current}} llamada(s) analizada(s). Para un análisis más confiable, se recomiendan {{minimum}} o más llamadas durante un período más largo para comprender mejor los patrones del cliente.",
  ...
  profileScreen: {
    ...
    emailManagedBySSO: "El correo lo gestiona tu proveedor de inicio de sesión y no se puede cambiar.",
    requestMyData: "Solicitar mis datos",
    verificationEmailFailed: "No se pudo enviar el correo de verificación. Inténtalo de nuevo.",
    verificationEmailSent: "¡Correo de verificación enviado! Revisa tu bandeja de entrada.",
    verifyEmail: "Verificar correo",
    verifyPhoneBannerMessage: "Verifica tu número de teléfono para recibir alertas de emergencia y notificaciones importantes. Puedes seguir usando la app con un teléfono no verificado.",
  },
  fraudAbuseAnalysis: {
    ...
    selectClientToView: "Por favor seleccione un cliente para ver el análisis de fraude y abuso",
    triggering: "Activando...",
    triggerAnalysis: "Activar Análisis",
    loadingResults: "Cargando resultados del análisis...",
    noResultsAvailable: "No hay resultados de análisis disponibles",
  ...
  schedulesScreen: {
    ...
    errorSavingSchedule: "Error al guardar el horario.",
    invalidScheduleError: "Completa todos los campos obligatorios del horario (frecuencia, hora y días para horarios semanales/mensuales).",
  ...
  themes: {
    ...
    highcontrast: {
      description: "Tema de máximo contraste para discapacidad visual (WCAG AAA)",
      name: "Alto contraste",
    },
  },
...
- Capacitar a nuestros sistemas para servir mejor a los clientes
...
- Nombre del cliente, número de teléfono, fecha de nacimiento
- Grabaciones de llamadas y transcripciones
...
**Español**: Si necesita ayuda, comuníquese con privacy@biancawellness.com`,
  ...
  callScreen: {
    onboardingNextRegular: "Cuando termine la incorporación, los controles usarán el formato habitual de bienestar.",
    onboardingNextWillBe: "Hasta completar la incorporación, la siguiente llamada saliente continuará la incorporación (sesión {{day}}).",
    onboardingProgress: "{{completed}} de {{total}} sesiones de incorporación completadas.",
    onboardingThisCall: "Esta llamada es la sesión de incorporación {{day}} de {{total}}. El recorrido avanza cuando el residente contesta y la sesión se completa.",
    onboardingTitle: "Incorporación del residente",
    title: "Llamada",
    noClientSelected: "Ningún cliente seleccionado",
    callWith: "Llamada con {{name}}",
  ...
  emailVerificationFailedPage: {
    helpExpired: "Los enlaces de verificación caducan a las 24 horas por seguridad.",
    helpGeneric: "Si crees que se trata de un error, contacta con soporte.",
    loginButton: "Ir al inicio de sesión",
    messageExpired: "Este enlace de verificación ha caducado. Solicita un nuevo correo de verificación.",
    messageInvalid: "Este enlace de verificación no es válido o ya se ha utilizado.",
  ...
  phoneVerificationScreen: {
    ...
    errorResendingCode: "No se pudo reenviar el código de verificación. Inténtalo de nuevo.",
    errorSendingCode: "No se pudo enviar el código de verificación. Inténtalo de nuevo.",
    errorVerifyingCode: "Código de verificación no válido. Inténtalo de nuevo.",
    invalidCode: "Introduce un código de 6 dígitos",
    message: "Hemos enviado un código de verificación de 6 dígitos a {{phone}}. Introdúcelo a continuación.",
  ...
  privacyRequestScreen: {
    accessMethodDownload: "Descarga",
    accessMethodEmail: "Correo electrónico",
    accessMethodInfo: "Tus datos se enviarán por correo como archivo JSON adjunto.",
    accessMethodLabel: "¿Cómo deseas recibir tus datos?",
    additionalInformationLabel: "Información adicional (opcional)",
    complaintDescriptionLabel: "Descripción *",
    complaintDescriptionPlaceholder: "Proporciona detalles de tu queja, incluido qué ocurrió y cuándo.",
    complaintFieldsRequired: "Completa el asunto y la descripción.",
    complaintHistoryTitle: "Historial de quejas",
    complaintRequestDescription: "Si crees que no hemos tratado tu información personal conforme a las leyes de privacidad, puedes presentar una queja. Investigaremos y responderemos en un plazo de 30 días.",
    complaintRequestTitle: "Queja de privacidad",
    complaintSubjectLabel: "Asunto *",
    complaintSubjectPlaceholder: "Breve descripción de tu queja",
    complaintSubmitted: "Tu queja se ha enviado. Investigaremos y responderemos en un plazo de 30 días.",
    completedOn: "Completado el",
    confirmDelete: "Eliminar",
    correctionFieldLabel: "Campo a corregir",
    correctionFieldPlaceholder: "p. ej., Correo, Teléfono, Nombre",
    correctionFieldsRequired: "Completa el nombre del campo y el valor solicitado.",
    correctionNote: "Nota: La mayoría de los datos se pueden editar directamente en la app. Usa este formulario para datos que no se pueden editar, como registros históricos o generados por el sistema.",
    correctionReasonLabel: "Motivo de la corrección (opcional)",
    correctionReasonPlaceholder: "¿Por qué debe corregirse esta información?",
    correctionRequestDescription: "Solicita una corrección de tu información personal. Indica qué debe corregirse.",
    correctionRequestSubmitted: "Tu solicitud de corrección se ha enviado. La revisaremos y procesaremos en un plazo de 30 días.",
    correctionRequestTitle: "Solicitud de corrección de datos",
    currentValue: "Valor actual",
    currentValueLabel: "Valor actual (opcional)",
    currentValuePlaceholder: "¿Cuál es el valor actual?",
    deletionCompleted: "Eliminación de datos completada correctamente.",
    deletionConfirmMessage: "Esto eliminará tus datos de forma permanente. Esta acción no se puede deshacer. ¿Seguro que deseas continuar?",
    deletionConfirmTitle: "Confirmar eliminación de datos",
    deletionDataTypeLabel: "¿Qué datos deseas eliminar?",
    deletionFailed: "No se pudieron eliminar los datos. Puede que no esté disponible en tu jurisdicción por requisitos legales de conservación.",
    deletionRequestDescription: "Según la PIPEDA, puedes solicitar la eliminación de tu información personal. Nota: HIPAA exige conservación de 7 años, por lo que la eliminación puede no estar disponible en todas las jurisdicciones.",
    deletionRequestTitle: "Solicitar eliminación de datos",
    deletionTypeAll: "Todos los datos",
    deletionTypeCalls: "Solo llamadas",
    deletionTypeConversations: "Solo conversaciones",
    deletionTypeMedicalAnalysis: "Solo análisis médico",
    field: "Campo",
    filedOn: "Presentada el",
    informationRequestedLabel: "Información solicitada",
    informationRequestedPlaceholder: "Toda mi información personal (o especifica lo que necesitas)",
    reason: "Motivo",
    requestDataDescription: "Describe qué información deseas consultar. Déjalo en blanco para solicitar toda tu información personal.",
    requestDataTitle: "Solicitud de acceso a datos",
    requestDeletion: "Solicitar eliminación de datos",
    requestFailed: "No se pudo enviar la solicitud. Inténtalo de nuevo.",
    requestHistoryTitle: "Historial de solicitudes",
    requestSubmitted: "Tu solicitud de datos se ha enviado. Recibirás un correo con tus datos en breve.",
    requestTypeAccess: "Solicitud de acceso",
    requestTypeComplaint: "Presentar queja",
    requestTypeCorrection: "Solicitud de corrección",
    requestedOn: "Solicitado el",
    requestedValue: "Valor solicitado",
    requestedValueLabel: "Valor solicitado *",
    requestedValuePlaceholder: "¿Cuál debe ser el valor corregido?",
    resolvedOn: "Resuelta el",
    submitRequest: "Enviar solicitud",
    subtitle: "Según la PIPEDA, tienes derecho a acceder y corregir tu información personal. Envía una solicitud para acceder o corregir tus datos.",
    title: "Solicitar mis datos",
    violationTypeAccess: "Problema de acceso",
    violationTypeLabel: "Tipo de problema (opcional)",
    violationTypeOther: "Otro",
  },
  caregiverInvitedScreen: {
    title: "¡Invitación enviada!",
    message: "Se envió una invitación a {{name}} en {{email}}.",
    continue: "Continuar",
    subMessage: "Recibirán un correo con instrucciones para completar el registro.",
  },
}
