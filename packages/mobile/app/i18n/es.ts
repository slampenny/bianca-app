...
const es: LocaleTranslations = {
  ...
  clientScreen: {
    ...
    onboardingNotStarted: "No iniciada — siguiente: Día 1 de 4",
    onboardingInProgress: "En curso",
    onboardingNextDay: "Siguiente: Día {{day}} de 4",
    onboardingCallsCompleted: "{{completed}} de 4 llamadas completadas",
