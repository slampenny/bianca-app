...
const fr: LocaleTranslations = {
  ...
  clientScreen: {
    ...
    onboardingNotStarted: "Non commencé — prochaine étape : jour 1 sur {{total}}",
    onboardingInProgress: "En cours",
    onboardingNextDay: "Prochain : jour {{day}} sur {{total}}",
    onboardingCallsCompleted: "{{completed}} appels sur {{total}} terminés",
