...
const ja: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    noAlertsForFilteredClientSubtitle: "{{name}} に紐づくアラートはありません。フィルターを解除してすべて表示するか、ホームで別のクライアントを選んでください。",
  },
  legalLinks: {
  ...
  emailVerificationScreen: {
    ...
    errorNetwork: "サーバーに接続できません。インターネット接続を確認して再試行してください。",
    errorNoToken: "確認トークンがありません",
    errorVerificationFailed: "メール確認に失敗しました",
  ...
  conversationsScreen: {
    ...
    firstConversation: "以前の会話が見つかりません。これがこのクライアントとの最初の会話になります。",
    noConversationsToDisplay: "表示する会話がありません",
    noPreviousConversations: "このクライアントの以前の会話が見つかりません",
    errorFetchingConversations: "会話の取得中にエラーが発生しました",
    loadingMoreConversations: "さらに会話を読み込み中...",
  },
  clientScreen: {
    nameLabel: "名前 *",
    namePlaceholder: "クライアントの名前を入力してください",
    emailLabel: "メール *",
    ...
    onboardingCardTitle: "入居者オンボーディング",
    onboardingNotStarted: "未開始 — 次は{{total}}日間のうち1日目",
    onboardingInProgress: "進行中",
    onboardingNextDay: "次：{{total}}日間のうち{{day}}日目",
    onboardingCallsCompleted: "{{total}}回の通話のうち{{completed}}回完了",
    onboardingCapturesLine: "トピック回答{{count}}件を記録",
    onboardingComplete: "オンボーディング完了 — {{total}}回の通話がすべて終了",
    ...
    onboardingOutboundCallsHint: "ホームまたはスケジュールからの発信通話は、電話でそのセッションが完了するまで第 {{day}} 回のオンボーディング会話を使用します。応答がない場合は進行せず、次の通話も同じセッションのままです。",
  },
  clientOnboardingScreen: {
    title: "オンボーディング回答",
    noClient: "クライアントが選択されていません。",
    day: "日目",
    filterByDay: "日で絞り込み",
    allDays: "すべての日",
    loading: "読み込み中…",
    ...
    signalsForDay: "{{day}} 日目に記録されたシグナル",
  },
  paymentScreen: {
    paid: "支払済み",
    pending: "保留中",
    ...
    dueDate: "支払期限：",
    notes: "備考：",
    clientsWithCharges: "料金のあるクライアント：",
    conversation: "件の会話",
    conversations: "件の会話",
    day: "日",
    days: "日",
  ...
  profileScreen: {
    ...
    emailManagedBySSO: "メールはサインインプロバイダーが管理しており、変更できません。",
    requestMyData: "データをリクエスト",
    verificationEmailFailed: "確認メールの送信に失敗しました。再試行してください。",
    verificationEmailSent: "確認メールを送信しました！受信トレイをご確認ください。",
    verifyEmail: "メールを確認",
    verifyPhoneBannerMessage: "緊急アラートと重要な通知を受け取るには、電話番号を確認してください。未確認の電話番号でもアプリを引き続き使用できます。",
  },
  fraudAbuseAnalysis: {
    title: "詐欺と虐待の分析",
    error: "エラー",
    success: "成功",
    noClientSelected: "クライアントが選択されていません",
    selectClientToView: "詐欺と虐待の分析を表示するにはクライアントを選択してください",
    triggering: "トリガー中...",
    ...
    insufficientDataWarning: "利用可能なデータが限られています：{{current}} 件の通話を分析しました。より信頼性の高い分析のためには、クライアントのパターンをよりよく理解するために、より長い期間にわたって {{minimum}} 件以上の通話を推奨します。",
  ...
  schedulesScreen: {
    ...
    errorSavingSchedule: "スケジュールの保存中にエラーが発生しました。",
    invalidScheduleError: "必須のスケジュール項目（頻度、時間、週次/月次の日付）をすべて入力してください。",
  ...
  scheduleComponent: {
    ...
    active: "アクティブ",
    everyDayAt: "毎日 {{time}}",
    everyDaysAt: "{{days}} ごとに {{time}}",
    everyMonthOn: "毎月 {{day}} 日 {{time}}",
    everyWeekAt: "毎週 {{time}}",
  },
  caregiverScreen: {
    nameLabel: "名前",
    ...
    phoneLabel: "電話",
    phonePlaceholder: "電話",
    loadingUnassignedClients: "未割り当てのクライアントを読み込み中...",
    assigningClients: "クライアントを割り当て中...",
    clientsAssignedSuccess: "クライアントの割り当てが完了しました！",
    loadingCaregivers: "介護者を読み込み中...",
    save: "保存",
    invite: "招待",
    confirmDelete: "削除の確認",
    deleteCaregiver: "介護者を削除",
    assignUnassignedClients: "未割り当てのクライアントを割り当て",
    assignUnassignedClientsTitle: "未割り当てのクライアントを割り当て",
    selectAll: "すべて選択",
    deselectAll: "すべて解除",
    assignSelected: "選択したクライアントを割り当て",
    noUnassignedClientsFound: "未割り当てのクライアントはいません。",
  },
  caregiversScreen: {
    invited: "招待済み",
    edit: "編集",
  ...
  sentimentAnalysis: {
    ...
    sessionRequiredMessage: "セッションの有効期限が切れている可能性があります。感情分析を表示するには再度サインインしてください。サインイン画面がすでに開いている場合はそこで完了してください。",
    signInToContinueButton: "サインイン",
    accessDeniedTitle: "このレポートを読み込めません",
    accessDeniedMessage: "このクライアントの感情データにアクセスできないか、権限が変更された可能性があります。ホームからクライアントを選び直すか、管理者に問い合わせてください。",
    clientSentimentAnalysis: "クライアント感情分析",
    emotionalWellnessInsights: "感情的健康の洞察とトレンド",
    timeRange: "時間範囲：",
    noSentimentDataAvailable: "感情データが利用できません",
    noSentimentDataMessage: "クライアントが会話を完了すると、感情分析がここに表示されます。",
    ...
    clientMoodAssessment: "クライアント気分評価",
    concernLevel: "懸念レベル",
    ...
    directApiTest: "直接 API テスト",
    insufficientDataForTrend: "トレンド分析にデータが不足しています",
    lowConfidence: "信頼度が低い",
    needMoreConversations: "信頼できるトレンドにはさらに多くの会話が必要です",
    noRecentCallButHaveCalls: "最近の通話あり、感情分析なし",
    noRecentCallButHaveCallsMessage: "過去30日間に最近の通話がありますが、感情分析はまだありません。新しい通話は終了後に自動分析されます。古い通話は再処理が必要な場合があります。",
    noRecentConversations: "感情分析付きの最近の会話がありません",
  },
  headers: {
    home: "ホーム",
    client: "クライアント",
    ...
    clientOnboarding: "オンボーディング",
    medicalAnalysis: "医学的分析",
    fraudAbuseAnalysis: "詐欺と虐待の分析",
    mentalHealthReport: "メンタルヘルスレポート",
    caregiver: "ケアギバー",
    caregiverInvited: "ケアギバーを招待済み",
    caregivers: "ケアギバー",
    login: "ログイン",
    organization: "組織",
    payments: "支払い",
    privacyPolicy: "プライバシーポリシー",
    privacyPractices: "HIPAA プライバシー慣行",
    privacyRequest: "データをリクエスト",
    profile: "プロフィール",
    register: "登録",
    termsOfService: "利用規約",
  },
  medicalAnalysis: {
    ...
    success: "成功",
    noClientSelected: "クライアントが選択されていません",
    selectClientToView: "医学的分析を表示するにはクライアントを選択してください",
    triggering: "トリガー中...",
    triggerAnalysis: "分析をトリガー",
    loadingResults: "分析結果を読み込み中...",
    noResultsAvailable: "分析結果が利用できません",
    ...
    insufficientDataWarning: "利用可能なデータが限られています：{{current}} 件の通話を分析しました。より信頼性の高い分析のために、クライアントのパターンをよりよく理解するために、より長い期間にわたって {{minimum}} 件以上の通話を推奨します。",
  ...
  homeScreen: {
    ...
    guest: "ゲスト",
    addClient: "クライアントを追加",
    adminOnlyMessage: "組織管理者とスーパー管理者のみがクライアントを追加できます",
    ...
    glanceHintAlertsBody: "リスト内でこの利用者に紐づくアラートの件数です（クライアント、会話、スケジュールなど）。内容の確認や管理はアラートタブから行ってください。クライアント未紐づけのアラートはここに含まれません。",
    ...
    glanceHealth: "健康",
    glanceHealthA11y: "健康スコア {{score}}/100",
    glanceHintButtonA11y: "{{label}}について",
    glanceHintHealthBody: "最新の医療会話分析による総合ウェルネススコア（0–100、高いほど良好）。通話における認知・気分関連の言語パターンなどのシグナルを組み合わせています。臨床判断や完全な健康レポートの代替にはなりません。",
    glanceHintHealthTitle: "健康スコア",
    glanceHintRiskBody: "最新の不正・安全分析による総合リスクスコア（0–100、高いほど懸念が大きい）。金銭、安全、孤立などの話題に関するパターンを反映しています。詳細は不正・虐待レポートをご確認ください。",
    glanceHintRiskTitle: "リスクスコア",
    glanceHintSentimentBody: "最近分析された通話（約30日間）におけるクライアントのトーンの概要。上昇・安定・下降は、より新しい通話をやや古い通話と比較したものです。診断ではありません—詳細は完全な感情分析レポートをご参照ください。",
    glanceHintSentimentTitle: "気分の傾向",
    glanceNoData: "—",
    glanceRisk: "リスク",
    glanceRiskA11y: "リスクスコア {{score}}/100",
    glanceSentiment: "気分",
    lastAnsweredCall: "最後に応答した通話",
    lastCalled: "最後の発信",
    neverCalled: "なし",
    noAnsweredCallsYet: "応答した通話はまだありません",
    sentimentTrendDeclining: "下降",
    sentimentTrendImproving: "上昇",
    sentimentTrendStable: "安定",
  },
  tabs: {
    home: "ホーム",
    org: "組織",
  ...
  orgScreen: {
    ...
    alertOnAllMissedCallsHelper: "不在着信と再試行のたびにアラートを送信",
    alertOnAllMissedCallsLabel: "すべての不在着信でアラート",
    callRetrySettings: "通話再試行設定",
    clientConsentSettings: "クライアント同意設定",
    country: "国",
    countryHelper: "組織の所在国を選択してください。適用されるプライバシー規制の特定に役立ちます。",
    enableRetriesHelper: "有効にすると、システムが失敗した通話を自動的に再試行します",
    enableRetriesLabel: "通話再試行を有効化",
    retryCountHelper: "応答がない場合の再試行回数（1–5）",
    retryCountLabel: "通話再試行回数",
    retryIntervalMinutesHelper: "再試行間の待機時間（1–60分、デフォルト：15）",
    retryIntervalMinutesLabel: "再試行間隔（分）",
    timezone: "タイムゾーン",
    timezoneHelper: "組織のタイムゾーンを選択してください。スケジュール時間はこのタイムゾーンに基づきます。",
  },
  themes: {
    healthcare: {
      name: "ヘルスケア",
    ...
    highcontrast: {
      description: "視覚障害向けの最大コントラストテーマ（WCAG AAA）",
      name: "高コントラスト",
    },
  },
...
- AI検出アルゴリズムを改善
- 品質保証と改善
- クライアントにより良いサービスを提供するためにシステムを訓練
...
**Español**: Si necesita ayuda, comuníquese con privacy@biancawellness.com`,
  ...
  callScreen: {
    onboardingNextRegular: "オンボーディング完了後、チェックインは通常のウェルネス形式を使用します。",
    onboardingNextWillBe: "オンボーディングが完了するまで、次の発信通話はオンボーディング（第 {{day}} 回セッション）を続けます。",
    onboardingProgress: "オンボーディングセッション {{completed}}/{{total}} 完了。",
    onboardingThisCall: "この通話は {{total}} 回中 {{day}} 回目のオンボーディングセッションです。入居者が応答しセッションが完了すると、プロセスが進みます。",
    onboardingTitle: "入居者オンボーディング",
    title: "通話",
    noClientSelected: "クライアントが選択されていません",
    callWith: "{{name}} との通話",
    callDetails: "通話の詳細",
    ...
    statusLabel: "ステータス：",
    liveIndicator: "ライブ",
    aiSpeaking: "AI が話しています...",
    userSpeaking: "ユーザーが話しています...",
  },
  caregiverInvitedScreen: {
    continue: "続ける",
    message: "介護者への招待が正常に送信されました。",
    title: "招待を送信しました！",
    subMessage: "They will receive an email with instructions to complete their registration.",
  },
  confirmResetScreen: {
    backToLogin: "ログインに戻る",
    codeFieldLabel: "リセットコード",
    codeFieldPlaceholder: "リセットコードを入力",
    confirmPasswordFieldLabel: "新しいパスワードの確認",
    confirmPasswordFieldPlaceholder: "新しいパスワードを確認",
    confirmPasswordLabel: "新しいパスワードの確認",
    confirmPasswordPlaceholder: "新しいパスワードを確認",
    confirmReset: "リセットを確認",
    newPasswordFieldLabel: "新しいパスワード",
    newPasswordFieldPlaceholder: "新しいパスワードを入力",
    newPasswordLabel: "新しいパスワード",
    newPasswordPlaceholder: "新しいパスワードを入力",
    redirecting: "ログインにリダイレクトしています...",
    requestFailed: "パスワードのリセットに失敗しました。コードを確認して再試行してください。",
    resetPasswordButton: "パスワードをリセット",
    subtitle: "以下に新しいパスワードを入力してください。安全で覚えやすいものにしてください。",
    successMessage: "パスワードが更新されました。新しいパスワードでログインできます。",
    successMessageShort: "パスワードが正常にリセットされました！",
    successTitle: "パスワードのリセットが完了しました！",
    title: "パスワードをリセット",
  },
  emailVerificationFailedPage: {
    helpExpired: "セキュリティのため、確認リンクは24時間後に失効します。",
    helpGeneric: "エラーだと思われる場合は、サポートにお問い合わせください。",
    loginButton: "ログインへ",
    messageExpired: "この確認リンクは失効しています。新しい確認メールをリクエストしてください。",
    messageInvalid: "この確認リンクは無効か、すでに使用されています。",
    title: "確認に失敗しました",
  },
  phoneVerificationScreen: {
    ...
    errorResendingCode: "確認コードの再送信に失敗しました。再試行してください。",
    errorSendingCode: "確認コードの送信に失敗しました。再試行してください。",
    errorVerifyingCode: "確認コードが無効です。再試行してください。",
    invalidCode: "6桁のコードを入力してください",
    message: "{{phone}} に6桁の確認コードを送信しました。以下に入力してください。",
    resendAvailableIn: "再送信可能まで",
    resendButton: "コードを再送信",
    sendCodeButton: "確認コードを送信",
    title: "電話番号を確認",
    verifyButton: "電話を確認",
  },
  privacyRequestScreen: {
    accessMethodDownload: "ダウンロード",
    accessMethodEmail: "メール",
    accessMethodInfo: "データは JSON 添付ファイルとしてメールで送信されます。",
    accessMethodLabel: "データの受け取り方法",
    additionalInformationLabel: "追加情報（任意）",
    complaintDescriptionLabel: "説明 *",
    complaintDescriptionPlaceholder: "苦情の詳細（何が起きたか、いつ）を記載してください。",
    complaintFieldsRequired: "件名と説明を入力してください。",
    complaintHistoryTitle: "苦情履歴",
    complaintRequestDescription: "個人情報がプライバシー法に従って処理されていないと思われる場合、苦情を提出できます。30日以内に調査し回答します。",
    complaintRequestTitle: "プライバシー苦情",
    complaintSubjectLabel: "件名 *",
    complaintSubjectPlaceholder: "苦情の簡単な説明",
    complaintSubmitted: "苦情が提出されました。30日以内に調査し回答します。",
    completedOn: "完了日",
    confirmDelete: "削除",
    correctionFieldLabel: "修正するフィールド",
    correctionFieldPlaceholder: "例：メール、電話、氏名",
    correctionFieldsRequired: "フィールド名とリクエスト値を入力してください。",
    correctionNote: "注：ほとんどのデータはアプリ内で直接編集できます。編集できない履歴ログやシステム生成レコードには、このフォームを使用してください。",
    correctionReasonLabel: "修正理由（任意）",
    correctionReasonPlaceholder: "この情報を修正する必要がある理由は？",
    correctionRequestDescription: "個人情報の修正をリクエストしてください。修正が必要な内容の詳細を記載してください。",
    correctionRequestSubmitted: "修正リクエストが提出されました。30日以内に審査・処理します。",
    correctionRequestTitle: "データ修正リクエスト",
    currentValue: "現在の値",
    currentValueLabel: "現在の値（任意）",
    currentValuePlaceholder: "現在の値は何ですか？",
    deletionCompleted: "データ削除が正常に完了しました。",
    deletionConfirmMessage: "データが永久に削除されます。この操作は元に戻せません。続行してもよろしいですか？",
    deletionConfirmTitle: "データ削除の確認",
    deletionDataTypeLabel: "削除するデータ",
    deletionFailed: "データの削除に失敗しました。法的保存要件により、お住まいの管轄では利用できない場合があります。",
    deletionRequestDescription: "PIPEDA に基づき、個人情報の削除をリクエストできます。注：HIPAA は7年間の保存を要求するため、すべての管轄で削除が可能とは限りません。",
    deletionRequestTitle: "データ削除のリクエスト",
    deletionTypeAll: "すべてのデータ",
    deletionTypeCalls: "通話のみ",
    deletionTypeConversations: "会話のみ",
    deletionTypeMedicalAnalysis: "医療分析のみ",
    field: "フィールド",
    filedOn: "提出日",
    informationRequestedLabel: "リクエストする情報",
    informationRequestedPlaceholder: "すべての個人情報（または必要な内容を指定）",
    reason: "理由",
    requestDataDescription: "アクセスしたい情報を記載してください。空白の場合はすべての個人情報をリクエストします。",
    requestDataTitle: "データアクセスリクエスト",
    requestDeletion: "データ削除をリクエスト",
    requestFailed: "リクエストの送信に失敗しました。再試行してください。",
    requestHistoryTitle: "リクエスト履歴",
    requestSubmitted: "データリクエストが提出されました。まもなくデータを含むメールが届きます。",
    requestTypeAccess: "アクセスリクエスト",
    requestTypeComplaint: "苦情を提出",
    requestTypeCorrection: "修正リクエスト",
    requestedOn: "リクエスト日",
    requestedValue: "リクエスト値",
    requestedValueLabel: "リクエスト値 *",
    requestedValuePlaceholder: "修正後の値は何ですか？",
    resolvedOn: "解決日",
    submitRequest: "リクエストを送信",
    subtitle: "PIPEDA に基づき、個人情報へのアクセスおよび修正の権利があります。データへのアクセスまたは修正をリクエストしてください。",
    title: "データをリクエスト",
    violationTypeAccess: "アクセスの問題",
    violationTypeLabel: "問題の種類（任意）",
    violationTypeOther: "その他",
  },
  scheduleScreen: {
