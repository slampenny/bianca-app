...
const hu: LocaleTranslations = {
  ...
  clientScreen: {
    ...
    onboardingNotStarted: "Még nem kezdődött el — következő: 1. nap a 4-ből",
    onboardingInProgress: "Folyamatban",
    onboardingNextDay: "Következő: {{day}}. nap a 4-ből",
    onboardingCallsCompleted: "{{completed}} a 4 hívásból befejezve",
