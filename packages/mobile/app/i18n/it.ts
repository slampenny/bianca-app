...
const it: LocaleTranslations = {
  ...
  clientScreen: {
    ...
    onboardingNotStarted: "Non iniziato — prossimo: giorno 1 di 4",
    onboardingInProgress: "In corso",
    onboardingNextDay: "Prossimo: giorno {{day}} di 4",
    onboardingCallsCompleted: "{{completed}} di 4 chiamate completate",
