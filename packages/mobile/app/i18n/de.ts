...
const de: LocaleTranslations = {
  ...
  clientScreen: {
    ...
    onboardingNotStarted: "Noch nicht gestartet — als Nächstes: Tag 1 von 4",
    onboardingInProgress: "Läuft",
    onboardingNextDay: "Als Nächstes: Tag {{day}} von 4",
    onboardingCallsCompleted: "{{completed}} von 4 Anrufen abgeschlossen",
