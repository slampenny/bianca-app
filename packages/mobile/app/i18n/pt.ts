...
const pt: LocaleTranslations = {
  ...
  alertScreen: {
    ...
    noAlertsForFilteredClientSubtitle: "Não há alertas ligados a {{name}}. Limpe o filtro para ver todos os alertas ou escolha outro cliente a partir de Início.",
  },
  legalLinks: {
  ...
  emailVerificationScreen: {
    ...
    errorNoToken: "Token de verificação ausente",
    errorVerificationFailed: "Falha na verificação do e-mail",
    verificationFailed: "Falha na verificação do e-mail",
  ...
  conversationsScreen: {
    ...
    firstConversation: "Nenhuma conversa anterior encontrada. Esta será a primeira conversa com este cliente.",
    noConversationsToDisplay: "Nenhuma conversa para exibir",
    noPreviousConversations: "Nenhuma conversa anterior encontrada para este cliente",
    errorFetchingConversations: "Erro ao buscar conversas",
    loadingMoreConversations: "Carregando mais conversas...",
  },
  clientScreen: {
    nameLabel: "Nome *",
    namePlaceholder: "Digite o nome do cliente",
    emailLabel: "Email *",
    ...
    updateClient: "ATUALIZAR PACIENTE",
    createClient: "CRIAR PACIENTE",
    ...
    deleteClient: "EXCLUIR PACIENTE",
    onboardingCardTitle: "Integração do residente",
    onboardingNotStarted: "Não iniciada — próximo: Dia 1 de {{total}}",
    onboardingInProgress: "Em andamento",
    onboardingNextDay: "Próximo: Dia {{day}} de {{total}}",
    onboardingCallsCompleted: "{{completed}} de {{total}} chamadas concluídas",
    ...
    onboardingOutboundCallsHint: "Chamadas de saída da Início ou da agenda usam a conversa de integração da sessão {{day}} até ela ser concluída no telefone. Sem resposta não há progresso — a próxima chamada permanece na mesma sessão.",
  },
  clientOnboardingScreen: {
    ...
    signalsForDay: "Sinais registrados no dia {{day}}",
  },
  paymentScreen: {
    paid: "Pago",
    pending: "Pendente",
    ...
    notes: "Notas:",
    clientsWithCharges: "Clientes com cobranças:",
  ...
  profileScreen: {
    ...
    emailManagedBySSO: "O e-mail é gerenciado pelo seu provedor de login e não pode ser alterado.",
    requestMyData: "Solicitar meus dados",
    verificationEmailFailed: "Falha ao enviar o e-mail de verificação. Tente novamente.",
    verificationEmailSent: "E-mail de verificação enviado! Verifique sua caixa de entrada.",
    verifyEmail: "Verificar e-mail",
    verifyPhoneBannerMessage: "Verifique seu número de telefone para receber alertas de emergência e notificações importantes. Você pode continuar usando o app com um telefone não verificado.",
  },
  fraudAbuseAnalysis: {
    ...
    success: "Sucesso",
    noClientSelected: "Nenhum cliente selecionado",
    selectClientToView: "Por favor selecione um cliente para ver a análise de fraude e abuso",
    triggering: "Ativando...",
    ...
    insufficientDataWarning: "Dados limitados disponíveis: {{current}} chamada(s) analisada(s). Para uma análise mais confiável, {{minimum}} ou mais chamadas em um período mais longo são recomendadas para entender melhor os padrões do cliente.",
  ...
  reportsScreen: {
    ...
    chooseClient: "Escolher um cliente...",
  ...
  schedulesScreen: {
    ...
    errorSavingSchedule: "Erro ao salvar a agenda.",
    invalidScheduleError: "Preencha todos os campos obrigatórios da agenda (frequência, horário e dias para agendas semanais/mensais).",
  ...
  scheduleComponent: {
    ...
    scheduleDetails: "Detalhes do horário",
    active: "Ativo",
    everyDayAt: "Todos os dias às {{time}}",
    everyDaysAt: "A cada {{days}} às {{time}}",
    everyMonthOn: "Todo mês no dia {{day}} às {{time}}",
    everyWeekAt: "Toda semana às {{time}}",
  },
  caregiverScreen: {
    namePlaceholder: "Nome",
    emailPlaceholder: "E-mail",
    phonePlaceholder: "Telefone",
    loadingUnassignedClients: "Carregando clientes não atribuídos...",
    assigningClients: "Atribuindo clientes...",
    clientsAssignedSuccess: "Clientes atribuídos com sucesso!",
    loadingCaregivers: "Carregando cuidadores...",
    assignSelected: "Atribuir selecionados",
    assignUnassignedClients: "Atribuir clientes não atribuídos",
    assignUnassignedClientsTitle: "Atribuir clientes não atribuídos",
    confirmDelete: "CONFIRMAR EXCLUSÃO",
    deleteCaregiver: "EXCLUIR CUIDADOR",
    deselectAll: "Desmarcar todos",
    emailLabel: "E-mail",
    invite: "CONVIDAR",
    nameLabel: "Nome",
    noUnassignedClientsFound: "Nenhum cliente não atribuído encontrado.",
    phoneLabel: "Telefone",
    save: "SALVAR",
  ...
  sentimentAnalysis: {
    ...
    sessionRequiredMessage: "A sua sessão pode ter expirado. Inicie sessão novamente para ver a análise de sentimentos. Se a janela de início de sessão já estiver aberta, conclua o acesso lá.",
    signInToContinueButton: "Iniciar sessão",
    accessDeniedTitle: "Não foi possível carregar este relatório",
    accessDeniedMessage: "Pode não ter acesso aos dados de sentimento deste cliente, ou as suas permissões podem ter mudado. Tente novamente a partir de Início ou contacte um administrador.",
    ...
    noSentimentDataMessage: "A análise de sentimentos aparecerá aqui assim que o cliente completar conversas.",
    ...
    clientMoodAssessment: "Avaliação do humor do cliente",
    ...
    recommendations: "Recomendações",
    lowConcernDescription: "Nível baixo de preocupação - o cliente parece estar bem.",
    ...
    pleaseSelectClient: "Por favor, selecione um cliente primeiro",
    ...
    directApiTest: "Teste direto de API",
    ...
    noRecentCallButHaveCalls: "Chamadas recentes, sem análise de sentimento ainda",
    noRecentCallButHaveCallsMessage: "Você tem chamadas recentes nos últimos 30 dias, mas nenhuma tem análise de sentimento ainda. Novas chamadas serão analisadas automaticamente ao terminar. Chamadas antigas podem precisar ser reprocessadas.",
    noRecentConversations: "Nenhuma conversa recente com análise de sentimento",
  },
  headers: {
    home: "Início",
    client: "Cliente",
    ...
    privacyPolicy: "Política de privacidade",
    privacyPractices: "Práticas de privacidade HIPAA",
    privacyRequest: "Solicitar meus dados",
    profile: "Perfil",
    register: "Registrar",
    termsOfService: "Termos de serviço",
  },
  medicalAnalysis: {
    ...
    success: "Sucesso",
    noClientSelected: "Nenhum cliente selecionado",
    selectClientToView: "Por favor, selecione um cliente para ver a análise médica",
    ...
    insufficientDataWarning: "Dados limitados disponíveis: {{current}} chamada(s) analisada(s). Para uma análise mais confiável, {{minimum}} ou mais chamadas ao longo de um período mais longo são recomendadas para entender melhor os padrões do cliente.",
  ...
  homeScreen: {
    ...
    adminOnlyMessage: "Apenas administradores de organização e super administradores podem adicionar clientes",
    ...
    glanceHintAlertsBody: "Quantos alertas da sua lista estão ligados a este residente (por exemplo alertas de cliente, conversa ou agenda). Abra a aba Alertas para ler ou gerenciar. Alertas sem cliente associado não entram nesta contagem.",
    ...
    glanceHealth: "Saúde",
    glanceHealthA11y: "Pontuação de saúde {{score}} de cem",
    glanceHintButtonA11y: "Sobre {{label}}",
    glanceHintHealthBody: "Pontuação geral de bem-estar da última análise médica de conversa (0–100, quanto maior, melhor). Combina sinais como padrões cognitivos e de humor nas chamadas. Não substitui julgamento clínico nem o relatório de saúde completo.",
    glanceHintHealthTitle: "Pontuação de saúde",
    glanceHintRiskBody: "Pontuação geral de risco da última análise de fraude e segurança (0–100, quanto maior, mais preocupação). Reflete padrões sobre dinheiro, segurança, isolamento e temas similares. Consulte o relatório de fraude e abuso para detalhes.",
    glanceHintRiskTitle: "Pontuação de risco",
    glanceHintSentimentBody: "Resumo do tom do cliente em chamadas analisadas recentemente (cerca dos últimos 30 dias). Alta, estável ou baixa compara chamadas mais novas com as um pouco mais antigas. Não é diagnóstico — consulte o relatório completo de sentimento.",
    glanceHintSentimentTitle: "Tendência de humor",
    glanceNoData: "—",
    glanceRisk: "Risco",
    glanceRiskA11y: "Pontuação de risco {{score}} de cem",
    glanceSentiment: "Humor",
    lastAnsweredCall: "Última chamada atendida",
    lastCalled: "Última chamada",
    neverCalled: "Nunca",
    noAnsweredCallsYet: "Nenhuma chamada atendida ainda",
    sentimentTrendDeclining: "Queda",
    sentimentTrendImproving: "Alta",
    sentimentTrendStable: "Estável",
  },
  tabs: {
    home: "Início",
    org: "Organização",
  ...
  orgScreen: {
    ...
    alertOnAllMissedCallsHelper: "Enviar alertas para cada chamada perdida e tentativa de reenvio",
    alertOnAllMissedCallsLabel: "Alertar em todas as chamadas perdidas",
    callRetrySettings: "Configurações de reenvio de chamada",
    clientConsentSettings: "Configurações de consentimento do cliente",
    country: "País",
    countryHelper: "Selecione o país da sua organização. Isso ajuda a determinar as regulamentações de privacidade aplicáveis.",
    enableRetriesHelper: "Quando ativado, o sistema reenviará automaticamente chamadas com falha",
    enableRetriesLabel: "Ativar reenvio de chamadas",
    retryCountHelper: "Número de vezes para reenviar se a chamada não for atendida (1-5)",
    retryCountLabel: "Número de reenvios",
    retryIntervalMinutesHelper: "Tempo de espera entre tentativas (1-60 minutos, padrão: 15)",
    retryIntervalMinutesLabel: "Intervalo de reenvio (minutos)",
    timezone: "Fuso horário",
    timezoneHelper: "Selecione o fuso horário da sua organização. Os horários da agenda serão baseados neste fuso horário.",
  },
  themes: {
    healthcare: {
      name: "Saúde",
    ...
    highcontrast: {
      description: "Tema de máximo contraste para deficiência visual (WCAG AAA)",
      name: "Alto contraste",
    },
  },
...
- Treinar nossos sistemas para servir melhor os clientes
...
- Nome do cliente, número de telefone, data de nascimento
- Gravações de chamadas e transcrições
...
**Español**: Si necesita ayuda, comuníquese con privacy@biancawellness.com`,
  ...
  callScreen: {
    onboardingNextRegular: "Após a integração, os check-ins usarão o formato habitual de bem-estar.",
    onboardingNextWillBe: "Até concluir a integração, a próxima chamada de saída continuará a integração (sessão {{day}}).",
    onboardingProgress: "{{completed}} de {{total}} sessões de integração concluídas.",
    onboardingThisCall: "Esta chamada é a sessão de integração {{day}} de {{total}}. O percurso avança quando o residente atende e a sessão é concluída.",
    onboardingTitle: "Integração do residente",
    title: "Chamada",
    noClientSelected: "Nenhum cliente selecionado",
    ...
    userSpeaking: "Usuário falando...",
  },
  caregiverInvitedScreen: {
    continue: "Continuar",
    message: "O convite do cuidador foi enviado com sucesso.",
    title: "Convite enviado!",
    subMessage: "They will receive an email with instructions to complete their registration.",
  },
  confirmResetScreen: {
    backToLogin: "Voltar ao login",
    codeFieldLabel: "Código de redefinição",
    codeFieldPlaceholder: "Digite seu código de redefinição",
    confirmPasswordFieldLabel: "Confirmar nova senha",
    confirmPasswordFieldPlaceholder: "Confirme sua nova senha",
    confirmPasswordLabel: "Confirmar nova senha",
    confirmPasswordPlaceholder: "Confirme sua nova senha",
    confirmReset: "Confirmar redefinição",
    newPasswordFieldLabel: "Nova senha",
    newPasswordFieldPlaceholder: "Digite sua nova senha",
    newPasswordLabel: "Nova senha",
    newPasswordPlaceholder: "Digite sua nova senha",
    redirecting: "Redirecionando para o login...",
    requestFailed: "Falha ao redefinir a senha. Verifique o código e tente novamente.",
    resetPasswordButton: "Redefinir senha",
    subtitle: "Digite sua nova senha abaixo. Certifique-se de que seja segura e fácil de lembrar.",
    successMessage: "Sua senha foi atualizada. Agora você pode entrar com a nova senha.",
    successMessageShort: "Sua senha foi redefinida com sucesso!",
    successTitle: "Senha redefinida com sucesso!",
    title: "Redefinir sua senha",
  },
  emailVerificationFailedPage: {
    helpExpired: "Por segurança, os links de verificação expiram após 24 horas.",
    helpGeneric: "Se acredita que isto é um erro, entre em contato com o suporte.",
    loginButton: "Ir para o login",
    messageExpired: "Este link de verificação expirou. Solicite um novo e-mail de verificação.",
    messageInvalid: "Este link de verificação é inválido ou já foi usado.",
  ...
  phoneVerificationScreen: {
    ...
    errorResendingCode: "Falha ao reenviar o código de verificação. Tente novamente.",
    errorSendingCode: "Falha ao enviar o código de verificação. Tente novamente.",
    errorVerifyingCode: "Código de verificação inválido. Tente novamente.",
    invalidCode: "Digite um código de 6 dígitos",
    message: "Enviamos um código de verificação de 6 dígitos para {{phone}}. Digite-o abaixo.",
    resendAvailableIn: "Reenvio disponível em",
    resendButton: "Reenviar código",
    sendCodeButton: "Enviar código de verificação",
  ...
  privacyRequestScreen: {
    ...
    accessMethodInfo: "Seus dados serão enviados por e-mail como anexo JSON.",
    accessMethodLabel: "Como você gostaria de receber seus dados?",
    additionalInformationLabel: "Informações adicionais (opcional)",
    complaintDescriptionLabel: "Descrição *",
    complaintDescriptionPlaceholder: "Forneça detalhes da sua reclamação, incluindo o que aconteceu e quando.",
    complaintFieldsRequired: "Preencha o assunto e a descrição.",
    complaintHistoryTitle: "Histórico de reclamações",
    complaintRequestDescription: "Se você acredita que não tratamos suas informações pessoais de acordo com as leis de privacidade, pode registrar uma reclamação. Investigaremos e responderemos em 30 dias.",
    complaintRequestTitle: "Reclamação de privacidade",
    complaintSubjectLabel: "Assunto *",
    complaintSubjectPlaceholder: "Breve descrição da sua reclamação",
    complaintSubmitted: "Sua reclamação foi enviada. Investigaremos e responderemos em 30 dias.",
    completedOn: "Concluído em",
    confirmDelete: "Excluir",
    correctionFieldLabel: "Campo a corrigir",
    correctionFieldPlaceholder: "ex.: E-mail, Telefone, Nome",
    correctionFieldsRequired: "Preencha o nome do campo e o valor solicitado.",
    correctionNote: "Nota: A maioria dos dados pode ser editada diretamente no app. Use este formulário para dados que não podem ser editados, como registros históricos ou gerados pelo sistema.",
    correctionReasonLabel: "Motivo da correção (opcional)",
    correctionReasonPlaceholder: "Por que essas informações precisam ser corrigidas?",
    correctionRequestDescription: "Solicite uma correção das suas informações pessoais. Informe o que precisa ser corrigido.",
    correctionRequestSubmitted: "Sua solicitação de correção foi enviada. Analisaremos e processaremos em 30 dias.",
    correctionRequestTitle: "Solicitação de correção de dados",
    currentValue: "Valor atual",
    currentValueLabel: "Valor atual (opcional)",
    currentValuePlaceholder: "Qual é o valor atual?",
    deletionCompleted: "Exclusão de dados concluída com sucesso.",
    deletionConfirmMessage: "Isso excluirá permanentemente seus dados. Esta ação não pode ser desfeita. Tem certeza de que deseja continuar?",
    deletionConfirmTitle: "Confirmar exclusão de dados",
    deletionDataTypeLabel: "Quais dados você deseja excluir?",
    deletionFailed: "Falha ao excluir dados. Isso pode não estar disponível na sua jurisdição devido a requisitos legais de retenção.",
    deletionRequestDescription: "De acordo com a PIPEDA, você pode solicitar a exclusão das suas informações pessoais. Nota: a HIPAA exige retenção de 7 anos, portanto a exclusão pode não estar disponível em todas as jurisdições.",
    deletionRequestTitle: "Solicitar exclusão de dados",
    deletionTypeAll: "Todos os dados",
    deletionTypeCalls: "Somente chamadas",
    deletionTypeConversations: "Somente conversas",
    deletionTypeMedicalAnalysis: "Somente análise médica",
    field: "Campo",
    filedOn: "Registrado em",
    informationRequestedLabel: "Informações solicitadas",
    informationRequestedPlaceholder: "Todas as minhas informações pessoais (ou especifique o que precisa)",
    reason: "Motivo",
    requestDataDescription: "Descreva quais informações você gostaria de acessar. Deixe em branco para solicitar todas as suas informações pessoais.",
    requestDataTitle: "Solicitação de acesso a dados",
    requestDeletion: "Solicitar exclusão de dados",
    requestFailed: "Falha ao enviar a solicitação. Tente novamente.",
    requestHistoryTitle: "Histórico de solicitações",
    requestSubmitted: "Sua solicitação de dados foi enviada. Você receberá um e-mail com seus dados em breve.",
    requestTypeAccess: "Solicitação de acesso",
    requestTypeComplaint: "Registrar reclamação",
    requestTypeCorrection: "Solicitação de correção",
    requestedOn: "Solicitado em",
    requestedValue: "Valor solicitado",
    requestedValueLabel: "Valor solicitado *",
    requestedValuePlaceholder: "Qual deve ser o valor corrigido?",
    resolvedOn: "Resolvido em",
    submitRequest: "Enviar solicitação",
    subtitle: "De acordo com a PIPEDA, você tem o direito de acessar e corrigir suas informações pessoais. Envie uma solicitação para acessar ou corrigir seus dados.",
    title: "Solicitar meus dados",
    violationTypeAccess: "Problema de acesso",
    violationTypeLabel: "Tipo de problema (opcional)",
    violationTypeOther: "Outro",
  },
  scheduleScreen: {
    deleteSchedule: "Excluir agenda",
    heading: "Configuração da agenda",
