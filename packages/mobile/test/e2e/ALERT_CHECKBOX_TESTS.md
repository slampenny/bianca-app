...
### 3. Frontend API Tests (`packages/mobile/app/services/api/__tests__/alertApi.test.ts`)
...
**Run with:**
```bash
cd packages/mobile && yarn test app/services/api/__tests__/alertApi.test.ts
```

### 4. E2E Cucumber Tests (`packages/mobile/test/e2e/cucumber/features/alert-management.feature`)
...
**Run with:**
```bash
cd packages/mobile && yarn test:cucumber
```

### 5. Additional E2E Playwright Tests (`packages/mobile/test/e2e/alert-checkbox.e2e.test.ts`)
...
**Run with:**
```bash
cd packages/mobile && yarn test:web:e2e test/e2e/alert-checkbox.e2e.test.ts
```
