...
const fraudAbuseAnalysisRoute = require('../../src/routes/v1/fraudAbuseAnalysis.route');
const telemetryRoute = require('../../src/routes/v1/telemetry.route');
...
router.use('/fraud-abuse-analysis', fraudAbuseAnalysisRoute);
