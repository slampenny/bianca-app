...
test.describe('Core Workflows - Essential User Journeys', () => {
  ...
  test('Workflow: User Registration Validation Journey', async ({ page }) => {
    ...
    // THEN: I should see the registration form is loaded
    await page.waitForSelector('[data-testid="register-name"]', { timeout: 10000 })
    
    // AND: I should be able to interact with form fields
