...
echo ""
echo "Redirect URIs configured for:"
echo "- Google: https://auth.expo.io/@negascout/bianca"
echo "- Microsoft: https://auth.expo.io/@negascout/bianca"
echo ""
echo "If you need to change these, update them in your OAuth provider consoles."
